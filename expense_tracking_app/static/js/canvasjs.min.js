...
(function () {
  ...
  function Ya(h, l, G) {
    "millisecond" === G
      ...
      : "year" === G && h.setFullYear(h.getFullYear() + 1 * l);
    return h;
  }
  function da(h, l) {
    var G = !1;
  ...
  function Aa(h) {
    h.roundRect = function (h, G, r, u, ra, C, E, z) {
      E && (this.fillStyle = E);
      ...
      this.beginPath();
      this.moveTo(h + ra, G);
      this.lineTo(h + r - ra, G);
      this.quadraticCurveTo(h + r, G, h + r, G + ra);
      this.lineTo(h + r, G + u - ra);
      this.quadraticCurveTo(h + r, G + u, h + r - ra, G + u);
      this.lineTo(h + ra, G + u);
      this.quadraticCurveTo(h, G + u, h, G + u - ra);
      this.lineTo(h, G + ra);
      this.quadraticCurveTo(h, G, h + ra, G);
      this.closePath();
      E && this.fill();
      z && 0 < C && this.stroke();
    };
  ...
  function K(h, l) {
    ...
    if (
      ...
      for (var r = 0; r < G.length; r++) G[r] *= l;
    else G = [];
    return G;
  }
  function R(h, l, G, u, ia) {
    u = u || [];
    ia = r(ia) ? (hb ? { passive: !1, capture: !1 } : !1) : ia;
    u.push([h, l, G, ia]);
    return h.addEventListener
      ? (h.addEventListener(l, G, ia), G)
      : h.attachEvent
      ? ((u = function (l) {
          l = l || window.event;
          l.preventDefault =
  ...
  function ib(h) {
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        var G = h._dropdownMenu.childNodes,
          r = [
      ...
      !h._dropdownMenu &&
        ...
        (G = -1 !== h.theme.indexOf("dark") ? "black" : "#888888"),
        X(h._dropdownMenu, {
          position: "absolute",
          zIndex: 1,
          userSelect: "none",
        ...
        X(G, { padding: "12px 8px 12px 8px" }),
        (G.innerHTML = h._cultureInfo.printText),
        (G.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (G.style.color = h.toolbar.fontColor),
        ...
        (G = document.createElement("div")),
        X(G, { padding: "12px 8px 12px 8px" }),
        (G.innerHTML = h._cultureInfo.saveJPGText),
        (G.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (G.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(G),
        R(
        ...
        (G = document.createElement("div")),
        X(G, { padding: "12px 8px 12px 8px" }),
        (G.innerHTML = h._cultureInfo.savePNGText),
        (G.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (G.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(G),
        R(
    ...
    u && bb
      ? ((ya =
          !r(ya) && ya
            ...
            : h.getContext("2d")),
        (Pa =
          ya.webkitBackingStorePixelRatio ||
          ya.mozBackingStorePixelRatio ||
          ya.msBackingStorePixelRatio ||
          ya.oBackingStorePixelRatio ||
          ya.backingStorePixelRatio ||
          1),
        (ma = Ta / Pa),
        (h.width = l * ma),
        (h.height = G * ma),
  ...
  function ta(h, l, r) {
    ...
    l.getAttribute("state") !== r &&
      (l.setAttribute("state", r),
      ...
      (l.innerHTML =
        ...
        "' />"),
      X(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
    l.setAttribute("title", h._cultureInfo[r + "Text"]);
  }
  function Na() {
  ...
  function Ua(h, l, r, u, ia) {
    if (null === h || "undefined" === typeof h)
      return "undefined" === typeof r ? l : r;
    h =
      parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? l / 100 : 1);
    "undefined" !== typeof u &&
      ((h = Math.min(u, h)),
      "undefined" !== typeof ia && (h = Math.max(ia, h)));
    return !isNaN(h) && h <= l && 0 <= h ? h : "undefined" === typeof r ? l : r;
  }
  function L(h, l, G, u, ia) {
    this._defaultsKey = h;
    ...
    h = {};
    this.theme && r(this.parent) && r(l) && r(u)
      ...
      : this.parent &&
        ...
        (null === u
          ...
          : 0 < this.parent.themeOptions[l].length &&
            ((u = Math.min(this.parent.themeOptions[l].length - 1, u)),
            (h = this.parent.themeOptions[l][u])));
    this.themeOptions = h;
    this.options = G ? G : { _isPlaceholder: !0 };
    this.setOptions(this.options, h);
  }
  function Ga(h, l, r, u, ia) {
  ...
  function Ba(h, l) {
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var G = h.options.subtitles, u = 0; u < G.length; u++)
        if (
          ((r(G[u].horizontalAlign) && "center" === this.horizontalAlign) ||
            G[u].horizontalAlign === this.horizontalAlign) &&
          ((r(G[u].verticalAlign) && "top" === this.verticalAlign) ||
            G[u].verticalAlign === this.verticalAlign) &&
          !G[u].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function Ka(h, l, r) {
    Ka.base.constructor.call(this, "Subtitle", "subtitles", l, r, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  var Ja = !1,
    ...
    Ma = { en: {} },
    E = u ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    Ha = u ? "Impact, Charcoal, sans-serif" : "Arial",
    Ca = {
      colorSet1:
  ...
  var hb = (function () {
    ...
    Da = (function () {
      var h =
        ...
        ia = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),
        E =
          /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
        C = /[^-+\dA-Z]/g;
      return function (z, K, Q) {
        var M = Q ? Q.days : l,
          Z = Q ? Q.months : u,
          R = Q ? Q.shortDays : r,
          V = Q ? Q.shortMonths : ia;
        Q = "";
        var X = !1;
        z = z && z.getTime ? z : z ? new Date(z) : new Date();
        if (isNaN(z)) throw SyntaxError("invalid date");
        "UTC:" === K.slice(0, 4) && ((K = K.slice(4)), (X = !0));
        Q = X ? "getUTC" : "get";
        var L = z[Q + "Date"](),
          P = z[Q + "Day"](),
          Y = z[Q + "Month"](),
          ...
          b = z[Q + "Seconds"](),
          e = z[Q + "Milliseconds"](),
          g = X ? 0 : z.getTimezoneOffset();
        return (Q = K.replace(h, function (p) {
          switch (p) {
            case "D":
              return L;
            case "DD":
            ...
            case "K":
              return X
                ? "UTC"
                : (String(z).match(E) || [""]).pop().replace(C, "");
            case "z":
    ...
    ea = function (h, l, r) {
      ...
      var u = 0 > h ? !0 : !1;
      u && (h *= -1);
      var E = r ? r.decimalSeparator : ".",
        z = r ? r.digitGroupSeparator : ",",
        C = "";
      l = String(l);
      var C = 1,
        K = (r = ""),
        ...
        if (((l = K[P]), "." === l && 0 > M)) M = P;
          ...
          if ("%" === l) C *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (L = !0);
          0 > M
            ? (Q.push(l), "#" === l || "0" === l ? R++ : "," === l && X++)
            : (Z.push(l), ("#" !== l && "0" !== l) || V++);
        }
      L &&
        ((l = Math.floor(h)),
        (K = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (S = 0 === h ? 0 : 0 === l ? -(R + K) : ob(l).length - R),
        (C /= Math.pow(10, S)));
      0 > M && (M = P);
      C = (h * C).toFixed(V);
      l = C.split(".");
      ...
      h = (l[1] + "").split("");
      C && "0" === C[0] && C.shift();
      for (L = K = P = V = M = 0; 0 < Q.length; )
        if (((l = Q.pop()), "#" === l || "0" === l))
          if ((M++, M === R)) {
            var Y = C,
              C = [];
            if ("0" === l)
              for (l = R - V - (Y ? Y.length : 0); 0 < l; ) Y.unshift("0"), l--;
            for (; 0 < Y.length; )
              (r = Y.pop() + r),
                L++,
                0 === L % K && P === X && 0 < Y.length && (r = z + r);
          } else
            0 < C.length
              ? ((r = C.pop() + r), V++, L++)
              : "0" === l && ((r = "0" + r), V++, L++),
              0 === L % K && P === X && 0 < C.length && (r = z + r);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (P++, (K = L), (L = 0), 0 < C.length && (r = z + r))
              : (r =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Pa = 1,
    ma = bb ? Ta / Pa : 1,
    $ = function (h, l, r, u, z, E, C, K, M, Q, Z, V, R) {
      "undefined" === typeof R && (R = 1);
      C = C || 0;
      K = K || "black";
      var L = 15 < u - l && 15 < z - r ? 8 : 0.35 * Math.min(u - l, z - r);
      h.beginPath();
      h.moveTo(l, r);
      h.save();
      h.fillStyle = E;
      h.globalAlpha = R;
      h.fillRect(l, r, u - l, z - r);
      h.globalAlpha = 1;
      0 < C &&
        ((R = 0 === C % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = K),
        h.moveTo(l, r),
        h.rect(l - R, r - R, u - l + 2 * R, z - r + 2 * R),
        h.stroke());
      h.restore();
      !0 === M &&
        (h.save(),
        ...
        h.lineTo(u, r),
        h.closePath(),
        (C = h.createLinearGradient((u + l) / 2, r + L, (u + l) / 2, r)),
        C.addColorStop(0, E),
      ...
      !0 === Q &&
        ...
        h.lineTo(u, z),
        h.closePath(),
        (C = h.createLinearGradient((u + l) / 2, z - L, (u + l) / 2, z)),
        C.addColorStop(0, E),
        C.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = C),
        h.fill(),
      ...
      !0 === Z &&
        ...
        h.lineTo(l, z),
        h.closePath(),
        (C = h.createLinearGradient(l + L, (z + r) / 2, l, (z + r) / 2)),
        C.addColorStop(0, E),
      ...
      !0 === V &&
        ...
        h.lineTo(u - L, z - L),
        h.lineTo(u, z),
        (C = h.createLinearGradient(u - L, (z + r) / 2, u, (z + r) / 2)),
        C.addColorStop(0, E),
        C.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = C),
        C.addColorStop(0, E),
  ...
  L.prototype.setOptions = function (h, l) {
    if (qa[this._defaultsKey]) {
      ...
      for (u in r)
        "publicProperties" !== u &&
          r.hasOwnProperty(u) &&
          (this[u] = h && u in h ? h[u] : l && u in l ? l[u] : r[u]);
  ...
  L.prototype.set = function (h, l, r) {
  ...
  L.prototype.addTo = function (h, l, r, u) {
    u = "undefined" === typeof u ? !0 : u;
    var z = qa[this._defaultsKey];
    z.hasOwnProperty(h) ||
    (z.publicProperties &&
      z.publicProperties.hasOwnProperty(h) &&
      "readWrite" === z.publicProperties[h])
      ? (this.options._isPlaceholder && this.createUserOptions(),
  ...
  L.prototype.updateOption = function (h) {
    ...
    var l = qa[this._defaultsKey],
      ...
      K = this._index;
    this.theme && r(this.parent) && r(E) && r(K)
      ? (u = r(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === K
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((u = Math.min(this.parent.themeOptions[E].length - 1, K)),
            (u = this.parent.themeOptions[E][u])));
    this.themeOptions = u;
    h in l &&
      (z = h in this.options ? this.options[h] : u && h in u ? u[h] : l[h]);
    if (z === this[h]) return !1;
    this[h] = z;
    return !0;
  };
  ...
  L.prototype.addEventListener = function (h, l, r) {
    h &&
      l &&
  ...
  L.prototype.dispatchEvent = function (h, l, r) {
    if (h && this._eventListeners[h]) {
      l = l || {};
      for (var u = this._eventListeners[h], z = 0; z < u.length; z++)
        u[z].eventHandler.call(u[z].context, l);
    }
  ...
  ka.prototype._getLineWithWidth = function (h, l, r) {
    h = String(h);
    if (!h) return { text: "", width: 0 };
    var u = (r = 0),
      z = h.length - 1,
      E = Infinity;
    for (this.ctx.font = this._getFontString(); u <= z; ) {
      var E = Math.floor((u + z) / 2),
        C = h.substr(0, E + 1);
      r = this.ctx.measureText(C).width;
      if (r < l) u = E + 1;
      else if (r > l) z = E - 1;
      else break;
    }
    r > l &&
      1 < C.length &&
      ((C = C.substr(0, C.length - 1)), (r = this.ctx.measureText(C).width));
    l = !0;
    if (C.length === h.length || " " === h[C.length]) l = !1;
    l &&
      ((h = C.split(" ")),
      1 < h.length && h.pop(),
      (C = h.join(" ")),
      (r = this.ctx.measureText(C).width));
    return { text: C, width: r };
  };
  ka.prototype._wrapText = function () {
    var h = new String(Ia(String(this.text))),
      ...
      E = 0;
    this.ctx.font = this._getFontString();
    if (0 === this.frontSize) E = z = 0;
    else
      for (; 0 < h.length; ) {
        var K = this.maxHeight - (this.topPadding + this.bottomPadding),
        ...
        r.push(C);
        var L = E,
          E = Math.max(E, C.width),
          z = z + C.height,
          h = Ia(h.slice(C.text.length, h.length));
        K && z > K && ((C = r.pop()), (z -= C.height), (E = L));
      }
    this._wrappedText = { lines: r, width: E, height: z };
  ...
  Ba.prototype.setLayout = function () {
    if (this.text) {
      ...
      r(this.padding) || "number" !== typeof this.padding
        ? r(this.padding) ||
          ...
          (Q += this.padding.bottom
            ...
            : 0))
        : (Q = 2 * this.padding);
      this.wrap || (K = Math.min(K, 1.5 * this.fontSize + Q));
      K = new ka(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ? ((z = l.y1 + 2 + this.fontSize / 2 + 4), (M = "top"))
            : "bottom" === this.verticalAlign &&
              ((z = l.y2 - 2 - Q.height + this.fontSize / 2 + 4),
              (M = "bottom")),
          "left" === this.horizontalAlign
            ? (u = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (u = l.x1 + l.width / 2 - Q.width / 2)
            : "right" === this.horizontalAlign && (u = l.x2 - 2 - Q.width - C),
          (L = this.horizontalAlign),
          (this.width = Q.width),
          (this.height = Q.height))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((u = l.x1 + 2 + (this.fontSize / 2 + 4)),
              (z = l.y2 - 2 - (this.maxWidth / 2 - Q.width / 2)),
              (E = -90),
              (M = "left"),
              (this.width = Q.height),
              (this.height = Q.width))
            : "right" === this.horizontalAlign
            ? ((u = l.x2 - 2 - (this.fontSize / 2 + 4)),
              (z = l.y1 + 2 + (this.maxWidth / 2 - Q.width / 2)),
              (E = 90),
              (M = "right"),
              (this.width = Q.height),
              (this.height = Q.width))
            : "center" === this.horizontalAlign &&
              ((z =
                h.y1 + (h.height / 2 - Q.height / 2) + this.fontSize / 2 + 4),
              (u = h.x1 + (h.width / 2 - Q.width / 2)),
              (M = "center"),
              (this.width = Q.width),
              (this.height = Q.height)),
          (L = "center"));
      ...
      this.bounds = { x1: u, y1: z, x2: u + this.width, y2: z + this.height };
  ...
  Wa.prototype.get = function (h, r) {
    var u = null;
    0 < this.pool.length
      ? ((u = this.pool.pop()), Oa(u, h, r))
      : (u = va(h, r));
    return u;
  };
  ...
  var Ra = {
    ...
    formatNumber: function (h, r, u) {
      u = u || "en";
      if (Ma[u]) return ea(h, r || "#,##0.##", new La(u));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, r, u) {
      u = u || "en";
      if (Ma[u]) return Da(h, r || "DD MMM YYYY", new La(u));
      throw "Unknown Culture Name";
    },
  };
  ...
  E = Ra.Chart = (function () {
    ...
    function z(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[p].y - a[g].y) / b;
          c[c.length] =
            (a[t].x > a[g].x && 0 < D) || (a[t].x < a[g].x && 0 > D)
          ...
          b =
            (Math.abs(
              (a[p].x - a[g].x) /
                (0 === a[t].x - a[g].x ? 0.01 : a[t].x - a[g].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function E(a, d, c, b, e, g, p, t, D, k) {
      var m = 0;
    ...
    function M(a, d) {
      M.base.constructor.call(this, "Legend", "legend", d, null, a);
      this.chart = a;
    ...
    function ga(a, d, c, b) {
      ga.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", d, null, b);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    function ba(a, d, c, b, e, g) {
      ba.base.constructor.call(this, "Break", d, c, b, g);
      this.id = e;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = g;
    ...
    function da(a, d, c) {
      da.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = c;
          ...
          if (
            ...
            "normal" === e
              ? "xySwapped" === this.plotInfo.axisPlacement
                ? (g = 'You cannot combine "' + b.type + '" with bar chart')
                : "none" === this.plotInfo.axisPlacement
                ? (g = 'You cannot combine "' + b.type + '" with pie chart')
    ...
    l.prototype.renderElements = function () {
      if (this.height) {
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++)
          for (
            var g = this.plotInfo.plotTypes[d], p = 0;
            p < g.plotUnits.length;
            p++
          ) {
            var t = g.plotUnits[p],
              D = null;
            ...
            t.targetCanvas = null;
            this.animatedRender &&
              ((t.targetCanvas = va(this.width, this.height)),
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g = !1, p = 0;
          ...
          for (D = 0; D < t.dataPoints.length; D++) {
            ...
            t.dataPoints[D].x.getTime
              ? ((g = !0), (b = t.dataPoints[D].x.getTime()))
              : (b = t.dataPoints[D].x);
            e = t.dataPoints[D].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < D) {
              if (a.axisX.logarithmic) {
                ...
                (F = b - t.dataPoints[D - 1].x),
                  0 > F && (F *= -1),
                  c.minDiff > F && 0 !== F && (c.minDiff = F);
              null !== e &&
                null !== t.dataPoints[D - 1].y &&
                (a.axisY.logarithmic
                  ? ((F = e / t.dataPoints[D - 1].y),
                    1 > F && (F = 1 / F),
                    d.minDiff > F && 1 !== F && (d.minDiff = F))
                  : ((F = e - t.dataPoints[D - 1].y),
                    0 > F && (F *= -1),
                    d.minDiff > F && 0 !== F && (d.minDiff = F)));
            }
            if (b < q && !k) null !== e && (n = b);
            else {
              if (!k && ((k = !0), 0 < D)) {
        ...
        for (
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            n.dataPoints[q].x.getTime
              ? ((g = !0), (b = n.dataPoints[q].x.getTime()))
              : (b = n.dataPoints[q].x);
            ...
            if (b < x && !f) null !== n.dataPoints[q].y && (h = b);
            else {
              if (!f && ((f = !0), 0 < q)) {
                q -= 2;
                continue;
        ...
        for (
          ...
          for (m = 0; m < k.dataPoints.length; m++) {
            ...
            if ((e = k.dataPoints[m].y) && e.length) {
              ...
              F = !0;
              for (var w = 0; w < e.length; w++) null === e.k && (F = !1);
              F && (n || (h = f), (f = b));
            }
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
        ...
        for (
          ...
          for (D = 0; D < t.dataPoints.length; D++)
            ...
            !0 === t.dataPoints[D].isCumulativeSum
              ...
              ? ((t.dataPointEOs[D].cumulativeSumYStartValue = n),
                (t.dataPointEOs[D].cumulativeSum =
                  0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (t.dataPoints[D].y = 0 === D ? 0 : b),
                (n = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (b = 0))
              : ((e =
    ...
    l.prototype.calculateAutoBreaks = function () {
                  ...
                  if (
                    (b &&
                      ((t =
                        ...
                        100),
                      (g = h.dataPoints[q].x.getTime
                        ? h.dataPoints[q].x.getTime()
                        : h.dataPoints[q].x),
                      (t = Math.floor((g - p) / t)),
                      g < f[t].min && (f[t].min = g),
                      g > f[t].max && (f[t].max = g)),
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? h.dataPointEOs[q].cumulativeSum
                          : h.dataPoints[q].y) &&
                      g.length
                    )
                      for (var u = 0; u < g.length; u++)
                        (t = Math.floor((g[u] - m) / l)),
                          g[u] < d[t].min && (d[t].min = g[u]),
                          g[u] > d[t].max && (d[t].max = g[u]);
                    else
                      r(g) ||
                        ((t = Math.floor((g - m) / l)),
                        g < d[t].min && (d[t].min = g),
      ...
      for (var b, e = this, g = !1, p = 0; p < this._axes.length; p++)
        if (
      ...
      if (g) {
        for (p = 0; p < this.plotInfo.plotTypes.length; p++)
          for (
            g = this.plotInfo.plotTypes[p], t = 0;
            t < g.plotUnits.length;
            t++
          )
            (b = g.plotUnits[t]),
              "line" === b.type ||
    ...
    l.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (var b = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) {
        var g = null;
        (g = this._dataInRenderedOrder[e].getDataPointAtXY(a, d, c)) &&
          b.push(g);
      }
      a = null;
      d = !1;
    ...
    l.prototype.getObjectAtXY = function (a, d, c) {
      ...
      else if (u) b = ab(a, d, this._eventManager.ghostCtx);
      else
      ...
      for (var e = 0; e < b.length; e++)
        if ((r(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e]))
          for (var g = 0; g < this.axisY.length; g++)
            c[b[e]].push({
              viewportMinimum:
                this[b[e]][g].sessionVariables.newViewportMinimum,
              viewportMaximum:
      ...
      if (
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
            ...
            2 < Math.abs(c - e) &&
              2 < Math.abs(b - g) &&
              this._zoomPanToSelectedRegion(c, b, e, g) &&
              (p = !0);
          }
          p &&
      ...
      if ("none" !== this.plotInfo.axisPlacement) {
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (p = 0; p < this.axisX.length; p++)
            this.axisX[p].crosshair &&
              this.axisX[p].crosshair.enabled &&
              this.axisX[p].crosshair.renderLabel();
        if (this.axisX2 && 0 < this.axisX2.length)
          for (p = 0; p < this.axisX2.length; p++)
            this.axisX2[p].crosshair &&
              this.axisX2[p].crosshair.enabled &&
              this.axisX2[p].crosshair.renderLabel();
        if (this.axisY && 0 < this.axisY.length)
          for (p = 0; p < this.axisY.length; p++)
            this.axisY[p].crosshair &&
              this.axisY[p].crosshair.enabled &&
              this.axisY[p].crosshair.renderLabel();
        if (this.axisY2 && 0 < this.axisY2.length)
          for (p = 0; p < this.axisY2.length; p++)
            this.axisY2[p].crosshair &&
              this.axisY2[p].crosshair.enabled &&
              this.axisY2[p].crosshair.renderLabel();
      }
    };
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (p = 0; p < k.length; p++) {
        var n = k[p],
          ...
          f = n.convertPixelToValue({ x: c, y: b });
        if (q > f)
          var h = f,
            f = q,
            q = h;
        if (n.scaleBreaks)
          for (h = 0; !g && h < n.scaleBreaks._appliedBreaks.length; h++)
            g =
              n.scaleBreaks._appliedBreaks[h].startValue <= q &&
              n.scaleBreaks._appliedBreaks[h].endValue >= f;
        if (isFinite(n.dataInfo.minDiff))
          if (
            ((h = n.getApparentDifference(q, f, null, !0)),
            !(
              g ||
              (!(
                this.panEnabled &&
                ...
                ((n.logarithmic && h < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && h < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              f > n.maximum
            ))
          )
            D.push(n), m.push({ val1: q, val2: f }), (t = !0);
          else if (!e) {
            t = !1;
            break;
          }
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          ...
          q,
          f,
          p = na("indexLabelFontColor", m.dataPoint, m.dataSeries),
          h = na("indexLabelFontSize", m.dataPoint, m.dataSeries),
          t = na("indexLabelFontFamily", m.dataPoint, m.dataSeries),
          D = na("indexLabelFontStyle", m.dataPoint, m.dataSeries),
          k = na("indexLabelFontWeight", m.dataPoint, m.dataSeries),
          y = na("indexLabelBackgroundColor", m.dataPoint, m.dataSeries);
        q = na("indexLabelMaxWidth", m.dataPoint, m.dataSeries);
        f = na("indexLabelWrap", m.dataPoint, m.dataSeries);
        var x = na("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          s = na("indexLabelLineColor", m.dataPoint, m.dataSeries),
          l = r(m.dataPoint.indexLabelLineThickness)
        ...
        var B = m.dataPoint.indexLabelFormatter
          ? m.dataPoint.indexLabelFormatter(A)
          ...
          ? m.dataSeries.indexLabelFormatter(A)
        ...
        if (null !== B && "" !== B) {
          var v = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
            A = na("indexLabelOrientation", m.dataPoint, m.dataSeries),
            J = na("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            z = m.direction,
            e = m.dataSeries.axisX,
            g = m.dataSeries.axisY,
            C = !1,
            y = new ka(d, {
              x: 0,
              y: 0,
          ...
          if ("stackedarea100" === n) {
            ...
            if (
              ...
              Math.max.apply(null, m.dataPoint.y) < g.viewportMinimum ||
              Math.min.apply(null, m.dataPoint.y) > g.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("line") ||
            ...
            if (
              m.dataPoint.x < e.viewportMinimum ||
              m.dataPoint.x > e.viewportMaximum ||
              m.dataPoint.y < g.viewportMinimum ||
              m.dataPoint.y > g.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("column") ||
          ...
          p = t = 2;
          "horizontal" === A
            ? ((D = y.width), (k = y.height))
            : ((k = y.width), (D = y.height));
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            q = m.point.x - ("horizontal" === A ? D / 2 : D / 2 - h / 2);
            "inside" !== v
              ? ((e = c.y1),
                (g = c.y2),
                0 < z
                  ? ((f =
                      m.point.y + ("horizontal" === A ? h / 2 : 0) - k - t - b),
                    f < e &&
                      ((f =
                        "auto" === v
                          ? Math.max(m.point.y, e) + h / 2 + t
                          : e + h / 2 + t),
                      (C = f + k > m.point.y)))
                  : ((f = m.point.y + h / 2 + t + b),
                    f > g - k &&
                      ((f =
                        "auto" === v
                          ? Math.min(m.point.y, g) + h / 2 - k - t
                          : g + h / 2 - k),
                      (C = f < m.point.y))))
              : ((e = Math.max(m.bounds.y1, c.y1)),
                (g = Math.min(m.bounds.y2, c.y2 - k + h / 2)),
                (b =
                  0 <= n.indexOf("range") || "error" === n
                    ? 0 < z
                      ? Math.max(m.bounds.y1, c.y1) + h / 2 + t
                      : Math.min(m.bounds.y2, c.y2) + h / 2 - k + t
                    : (Math.max(m.bounds.y1, c.y1) +
                      ...
                      ("horizontal" === A ? t : 0)),
                0 < z
                  ? ((f = Math.max(m.point.y, b)),
                    f < e &&
                      ("bubble" === n || "scatter" === n) &&
                      (f = Math.max(m.point.y - k - t, c.y1 + t)))
                  : ((f = Math.min(m.point.y, b)),
                    f > g - k - t &&
                      ("bubble" === n || "scatter" === n) &&
                      (f = Math.min(m.point.y + t, c.y2 - k - t))),
                (f = Math.min(f, g)));
          } else
            0 <= n.indexOf("line") ||
            0 <= n.indexOf("area") ||
              ...
              "inside" !== v
                ? ((e = c.x1),
                  ...
                  0 > z
                    ? ((q =
                        m.point.x -
                        ("horizontal" === A ? D : D - h / 2) -
                        p -
                        b),
                      q < e &&
                        ((q =
                          "auto" === v ? Math.max(m.point.x, e) + p : e + p),
                        (C = q + D > m.point.x)))
                    : ((q =
                        m.point.x + ("horizontal" === A ? 0 : h / 2) + p + b),
                      q > g - D - p - b &&
                        ((q =
                          "auto" === v
                ...
                : ((e = Math.max(m.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= n.indexOf("range") || "error" === n
                      ? 0 > z
                        ? Math.max(m.bounds.x1, c.x1) + h / 2 + p
                        : Math.min(m.bounds.x2, c.x2) -
                          D / 2 -
                          p +
                          ("horizontal" === A ? 0 : h / 2)
          ...
          l &&
            ...
            d.setLineDash && d.setLineDash(K(x, l)),
            d.beginPath(),
            ...
            0 <= n.indexOf("bar") || ("error" === n && m.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < m.direction ? -p : D + p) +
                    ("vertical" === A ? -h / 2 : 0),
                  f + ("vertical" === A ? -k / 2 : k / 2 - h / 2) - t
                )
              : 0 <= n.indexOf("column") || ("error" === n && !m.axisSwapped)
              ? d.lineTo(
                  q + D / 2 - ("horizontal" === A ? 0 : h / 2),
                  f +
                    ("vertical" === A
                      ? (f - k < m.point.y ? 0 : -k) + t
                      : (f - h / 2 < m.point.y ? k : 0) - h / 2)
                )
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (y = na("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = r(y)
            ? u
              ? "transparent"
              : null
            : y);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var m = k.dataPoints,
            n = "solid";
          if (c.setLineDash) {
            var q = K(k.nullDataLineDashType, k.lineThickness),
              n = k.lineDashType,
              f = K(n, k.lineThickness);
            c.setLineDash(f);
          }
          var h = k.id;
          ...
          var h = k._colorSet,
            r =
              (h =
              k.lineColor =
                k.options.lineColor ? k.options.lineColor : h[0]);
          c.strokeStyle = h;
          var x = !0,
            s = 0,
            l,
          ...
          c.beginPath();
          if (0 < m.length) {
            for (var A = !1, s = 0; s < m.length; s++)
              if (
                ((l = m[s].x.getTime ? m[s].x.getTime() : m[s].x),
                !(
                  ...
                  x || A
                    ...
                    : (c.lineTo(l, v),
                      ...
                      0 == s % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(l, v),
                        u && (b.stroke(), b.beginPath(), b.moveTo(l, v))));
                  p = { x: l, y: v };
                  s < m.length - 1 &&
                    (r !== (m[s].lineColor || h) ||
                    ...
                    c.setLineDash &&
                      (m[s].lineDashType
                        ? ((n = m[s].lineDashType),
                          c.setLineDash(K(n, k.lineThickness)))
                        : ((n = k.lineDashType), c.setLineDash(f))));
                  if (
                    0 !== m[s].markerSize &&
                    (0 < m[s].markerSize || 0 < k.markerSize)
                  ) {
                    var J = k.getMarkerProperties(s, l, v, c);
                    g.push(J);
                    B = Z(B);
                    u &&
                      g.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var A = !1, s = 0; s < m.length; s++)
              if (
                ((w = m[s].getTime ? m[s].x.getTime() : m[s].x),
                !(
                ...
                if ("number" !== typeof m[s].y)
                  ...
                  l || A
                    ? (!l && k.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(w, B),
                          c.lineTo(w, v),
                          u && (b.lineTo(w, B), b.lineTo(w, v)))
                        : (c.beginPath(),
                          c.moveTo(w, v),
                          u && (b.beginPath(), b.moveTo(w, v))),
                      (A = l = !1))
                    : (c.lineTo(w, B),
                      u && b.lineTo(w, B),
                      c.lineTo(w, v),
                      ...
                      0 == s % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(w, v),
                        u && (b.stroke(), b.beginPath(), b.moveTo(w, v))));
                  p = { x: w, y: v };
                  s < m.length - 1 &&
                    (r !== (m[s].lineColor || F) ||
                      n !== (m[s].lineDashType || k.lineDashType)) &&
                  ...
                  0 !== m[s].markerSize &&
                    (0 < m[s].markerSize || 0 < k.markerSize) &&
                    ((B = k.getMarkerProperties(s, w, v, c)),
                    g.push(B),
                    (J = Z(J)),
                    u &&
                      g.push({
    ...
    l.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          b.beginPath();
          if (0 < m.length)
            for (w = !1, l = 0; l < m.length; l++)
              if (
                ((s = m[l].getTime ? m[l].x.getTime() : m[l].x),
                !(
                ...
                if ("number" !== typeof m[l].y)
                  ...
                  w = a.axisY.convertValueToPixel(m[l].y);
                  ...
                  l < m.length - 1 &&
                    ...
                    ((r = m[l].lineColor || F),
                    (v[v.length - 1].newStrokeStyle = r),
                    b.setLineDash &&
                      (m[l].lineDashType
                        ? ((n = m[l].lineDashType),
                          (v[v.length - 1].newLineDashArray = K(
                            n,
                            k.lineThickness
                          )))
                        : ((n = k.lineDashType),
                  ...
                  if (
                    0 !== m[l].markerSize &&
                    (0 < m[l].markerSize || 0 < k.markerSize)
                  ) {
                    var B = k.getMarkerProperties(l, s, w, b);
                    p.push(B);
                    A = Z(A);
                    u &&
                      p.push({
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < F.length)
            for (
              var r = 5 < n && f.bevelEnabled ? !0 : !1, g = 0;
              g < F.length;
              g++
            )
              if (
                (F[g].getTime ? (h = F[g].x.getTime()) : (h = F[g].x),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  h > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof F[g].y)
              ) {
                p = a.axisX.convertValueToPixel(h);
                ...
                $(
                  c,
                  a.axisX.reversed ? l : p,
                  t,
                  a.axisX.reversed ? p : l,
                  s,
                  b,
                  0,
                  null,
                  r && (a.axisY.reversed ? 0 > F[g].y : 0 <= F[g].y),
                  (a.axisY.reversed ? 0 <= F[g].y : 0 > F[g].y) && r,
                  !1,
                  !1,
                  f.fillOpacity
                );
                ...
                (F[g].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: p + (l - p) / 2,
                      y: 0 > F[g].y === a.axisY.reversed ? t : s,
                    },
                    direction: 0 > F[g].y === a.axisY.reversed ? 1 : -1,
                    bounds: {
                      x1: p,
                      y1: Math.min(t, s),
                      x2: l,
        ...
        return {
          source: d,
          dest: this.plotArea.ctx,
          animationCallback: P.yScaleAnimation,
    ...
    l.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (f = 0; f < a.dataSeriesIndexes.length; f++) {
          var r = a.dataSeriesIndexes[f],
            l = this.data[r],
            s = l.dataPoints;
          if (0 < s.length) {
            var w = 5 < F && l.bevelEnabled ? !0 : !1;
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (h[b] = s[k].y + (h[b] ? h[b] : 0)),
                    (A = a.axisY.convertValueToPixel(h[b])),
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < s.length)
            for (
              var w = 5 < F && r.bevelEnabled ? !0 : !1, k = 0;
              k < s.length;
              k++
            )
              if (
          ...
          if (0 < F.length) {
            ...
            for (g = 0; g < F.length; g++)
              if (
                ...
                $(
                  c,
                  a.axisY.reversed ? p : s,
                  a.axisX.reversed ? l : t,
                  a.axisY.reversed ? s : p,
                  a.axisX.reversed ? t : l,
                  b,
                  0,
                  null,
                  r,
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (h[b] = s[k].y + (h[b] ? h[b] : 0)),
                    (m = p[b] ? p[b] : q),
                    (p[b] = A = a.axisY.convertValueToPixel(h[b]));
                else if (
                ...
                $(
                  c,
                  a.axisY.reversed ? m : A,
                  n,
                  a.axisY.reversed ? A : m,
                  v,
                  b,
                  0,
                  null,
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (h[b] = v + (h[b] ? h[b] : 0)),
                    (m = p[b] ? p[b] : q),
                    (p[b] = v = a.axisY.convertValueToPixel(h[b]));
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        B &&
          ...
          g.fill(),
          (g.globalAlpha = 1),
          u && (p.lineTo(x, A), p.lineTo(B.x, A), p.closePath(), p.fill()),
          g.beginPath(),
          g.moveTo(x, s),
          p.beginPath(),
          p.moveTo(x, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          var r = 0,
            ...
            B = null;
          if (0 < l.length) {
            var J = f._colorSet[r % f._colorSet.length],
              z = (f.lineColor = f.options.lineColor || J),
              C = z;
            g.fillStyle = J;
            g.strokeStyle = z;
            ...
            for (var fa = !0; r < l.length; r++)
              if (
                ((w = l[r].x.getTime ? l[r].x.getTime() : l[r].x),
                !(
                  w < a.axisX.dataInfo.viewPortMin ||
                  (w > a.axisX.dataInfo.viewPortMax &&
                    (!f.connectNullData || !fa))
                ))
              )
                if ("number" !== typeof l[r].y)
                  f.connectNullData || fa || d || b(), (fa = !0);
                else {
                  x = a.axisX.convertValueToPixel(w);
                  s = a.axisY.convertValueToPixel(l[r].y);
                  d || fa
                    ? (!d && f.connectNullData
                        ? (g.setLineDash &&
                  ...
                  r < l.length - 1 &&
                    (C !== (l[r].lineColor || z) ||
                      c !== (l[r].lineDashType || f.lineDashType)) &&
                    (b(),
                    (C = l[r].lineColor || z),
                    (g.strokeStyle = C),
                    g.setLineDash &&
                      (l[r].lineDashType
                        ? ((c = l[r].lineDashType),
                          g.setLineDash(K(c, f.lineThickness)))
                        : ((c = f.lineDashType), g.setLineDash(U))));
                  var ca = f.dataPointIds[r];
                  ...
                  0 !== l[r].markerSize &&
                    (0 < l[r].markerSize || 0 < f.markerSize) &&
                    ((w = f.getMarkerProperties(r, x, s, g)),
                    h.push(w),
                    (ca = Z(ca)),
                    u &&
                      h.push({
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < n.length) {
            var v = m._colorSet[q % m._colorSet.length],
              A = (m.lineColor = m.options.lineColor || v),
              B = A;
            b.fillStyle = v;
            b.strokeStyle = A;
            ...
            var J = "solid";
            if (b.setLineDash) {
              var C = K(m.nullDataLineDashType, m.lineThickness),
                J = m.lineDashType,
                E = K(J, m.lineThickness);
              b.setLineDash(E);
            }
            for (l = !1; q < n.length; q++)
              if (
                ((f = n[q].x.getTime ? n[q].x.getTime() : n[q].x),
                !(
                ...
                if ("number" !== typeof n[q].y)
                  ...
                  q < n.length - 1 &&
                    (B !== (n[q].lineColor || A) ||
                      J !== (n[q].lineDashType || m.lineDashType)) &&
                    ((B = n[q].lineColor || A),
                    (w[w.length - 1].newStrokeStyle = B),
                    b.setLineDash &&
                      (n[q].lineDashType
                        ? ((J = n[q].lineDashType),
                          (w[w.length - 1].newLineDashArray = K(
                            J,
                            m.lineThickness
                          )))
                        : ((J = m.lineDashType),
                          (w[w.length - 1].newLineDashArray = E))));
                  if (
                    0 !== n[q].markerSize &&
                    (0 < n[q].markerSize || 0 < m.markerSize)
                  ) {
                    var U = m.getMarkerProperties(q, f, l, b);
                    p.push(U);
                    N = Z(N);
                    u &&
                      p.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < l.length) {
            ...
            var N = "solid";
            if (g.setLineDash) {
              var U = K(f.nullDataLineDashType, f.lineThickness),
                N = f.lineDashType,
                E = K(N, f.lineThickness);
              g.setLineDash(E);
            }
            for (; r < l.length; r++)
              if (
                ...
                "number" !== typeof l[r].y
                  ...
                  : ((x = a.axisX.convertValueToPixel(w)),
                    ...
                    d || c
                      ? (!d && f.connectNullData
                          ? (g.setLineDash &&
                              ...
                              (s = c),
                              (B = m),
                              (N = f.nullDataLineDashType),
                              g.setLineDash(U)),
                            g.lineTo(x, ca),
                            g.lineTo(x, s),
                            u && (p.lineTo(x, ca), p.lineTo(x, s)))
                          : (g.beginPath(),
                            g.moveTo(x, s),
                            u && (p.beginPath(), p.moveTo(x, s)),
                            (B = { x: x, y: s })),
                    ...
                    r < l.length - 1 &&
                      (C !== (l[r].lineColor || z) ||
                        N !== (l[r].lineDashType || f.lineDashType)) &&
                      (b(),
                      (C = l[r].lineColor || z),
                      (g.strokeStyle = C),
                      g.setLineDash &&
                        (l[r].lineDashType
                          ? ((N = l[r].lineDashType),
                            g.setLineDash(K(N, f.lineThickness)))
                          : ((N = f.lineDashType), g.setLineDash(E)))),
                    (w = f.dataPointIds[r]),
                    ...
                    0 !== l[r].markerSize &&
                      (0 < l[r].markerSize || 0 < f.markerSize) &&
                      ((ca = f.getMarkerProperties(r, x, s, g)),
                      h.push(ca),
                      (w = Z(w)),
                      u &&
                        h.push({
    ...
    l.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], A = 0; A < a.dataSeriesIndexes.length; A++) {
          var B = a.dataSeriesIndexes[A],
            J = this.data[B],
            z = J.dataPoints;
          J.dataPointIndexes = [];
          for (q = 0; q < z.length; q++)
            (B = z[q].x.getTime ? z[q].x.getTime() : z[q].x),
              (J.dataPointIndexes[B] = q),
              e[B] || (m.push(B), (e[B] = !0));
          m.sort(Sa);
        }
        for (A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < m.length) {
            var e = J._colorSet[0],
              C = (J.lineColor = J.options.lineColor || e),
              N = C;
            b.fillStyle = e;
            b.strokeStyle = C;
            ...
            if (b.setLineDash) {
              ...
              v = J.lineDashType;
              var E = K(v, J.lineThickness);
              b.setLineDash(E);
            }
            for (var ca = !0, q = 0; q < m.length; q++) {
              var g = m[q],
                ha = null,
                ha =
                  0 <= J.dataPointIndexes[g]
                    ? z[J.dataPointIndexes[g]]
                    : { x: g, y: null };
              if (
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  (g > a.axisX.dataInfo.viewPortMax &&
                    (!J.connectNullData || !ca))
                )
              )
                if ("number" !== typeof ha.y)
                  J.connectNullData || ca || w || d(), (ca = !0);
                else {
                  ...
                  if (
                    ...
                    n[g] = ha.y + (n[g] ? n[g] : 0);
                    if (0 >= n[g] && a.axisY.logarithmic) continue;
                    l = a.axisY.convertValueToPixel(n[g]);
                  } else (l = a.axisY.convertValueToPixel(ha.y)), (l -= oa);
                  k.push({ x: f, y: r - oa });
                  h[g] = r - l;
                  w || ca
                    ? (!w && J.connectNullData
                        ? (b.setLineDash &&
                            (J.options.nullDataLineDashType ||
                              (v === J.lineDashType &&
                                J.lineDashType !== J.nullDataLineDashType)) &&
                            ((w = k.pop()),
                            (v = k[k.length - 1]),
                            d(),
                            b.moveTo(s.x, s.y),
                            k.push(v),
                            k.push(w),
                            (v = J.nullDataLineDashType),
                            b.setLineDash(U)),
                          b.lineTo(f, l),
                          u && x.lineTo(f, l))
                        : (b.beginPath(),
                          b.moveTo(f, l),
                          u && (x.beginPath(), x.moveTo(f, l))),
                      (ca = w = !1))
                    : (b.lineTo(f, l),
                      u && x.lineTo(f, l),
                      0 == q % 250 &&
                  ...
                  q < z.length - 1 &&
                    (N !== (z[q].lineColor || C) ||
                      v !== (z[q].lineDashType || J.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(f, l),
                    k.push({ x: f, y: r - oa }),
                    ...
                    b.setLineDash &&
                      (z[q].lineDashType
                        ? ((v = z[q].lineDashType),
                          b.setLineDash(K(v, J.lineThickness)))
                        : ((v = J.lineDashType), b.setLineDash(E))));
                  if (0 <= J.dataPointIndexes[g]) {
                    ...
                    this._eventManager.objectMap[la] = {
                      ...
                      objectType: "dataPoint",
                      dataSeriesIndex: B,
                      dataPointIndex: J.dataPointIndexes[g],
                      x1: f,
                      y1: l,
                    };
                  }
                  0 <= J.dataPointIndexes[g] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < J.markerSize) &&
                    ((oa = J.getMarkerProperties(
                      J.dataPointIndexes[g],
                      f,
                      l,
                      b
                    )),
    ...
    l.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          k = [];
          if (0 < m.length) {
            var e = J._colorSet[q % J._colorSet.length],
              C = (J.lineColor = J.options.lineColor || e),
              N = C;
            b.fillStyle = e;
            b.strokeStyle = C;
            ...
            for (var ca = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  J.connectNullData || ca || x || d(), (ca = !0);
                else {
                  var oa;
                  oa =
                    0 !== a.dataPointYSums[g]
                      ? 100 * (ha.y / a.dataPointYSums[g])
                      : 0;
                  f = a.axisX.convertValueToPixel(g);
                  var la = h[g] ? h[g] : 0;
                  if (
                    ...
                    if (0 >= n[g] && a.axisY.logarithmic) continue;
                    l = a.axisY.convertValueToPixel(n[g]);
                  } else (l = a.axisY.convertValueToPixel(oa)), (l -= la);
                  k.push({ x: f, y: w - la });
                  h[g] = w - l;
                  x || ca
                    ? (!x && J.connectNullData
                        ? (b.setLineDash &&
                            ...
                            k.push(s),
                            k.push(x),
                            (s = J.nullDataLineDashType),
                            b.setLineDash(U)),
                          b.lineTo(f, l),
                          u && v.lineTo(f, l))
                        : (b.beginPath(),
                          b.moveTo(f, l),
                          u && (v.beginPath(), v.moveTo(f, l))),
                      (ca = x = !1))
                    : (b.lineTo(f, l),
                      u && v.lineTo(f, l),
                      0 == q % 250 &&
                  ...
                  q < z.length - 1 &&
                    (N !== (z[q].lineColor || C) ||
                      s !== (z[q].lineDashType || J.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(f, l),
                    k.push({ x: f, y: w - la }),
                    ...
                    b.setLineDash &&
                      (z[q].lineDashType
                        ? ((s = z[q].lineDashType),
                          b.setLineDash(K(s, J.lineThickness)))
                        : ((s = J.lineDashType), b.setLineDash(E))));
                  if (0 <= J.dataPointIndexes[g]) {
                  ...
                  0 <= J.dataPointIndexes[g] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < J.markerSize) &&
                    ((la = J.getMarkerProperties(q, f, l, b)),
                    t.push(la),
                    (g = Z(H)),
                    u &&
                      t.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          for (
            ...
            (g = q[e].getTime ? (g = q[e].x.getTime()) : (g = q[e].x)),
              g < a.axisX.dataInfo.viewPortMin ||
                g > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof q[e].z ||
                ((f = q[e].z), f > t && (t = f), f < h && (h = f));
        for (
          var l = 25 * Math.PI,
            r = Math.max(
    ...
    l.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          if (0 < w.length)
            for (
              var v = 5 < l && s.bevelEnabled ? !0 : !1, t = 0;
              t < w.length;
              t++
            )
              if (
                (w[t].getTime ? (f = w[t].x.getTime()) : (f = w[t].x),
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax
                ) &&
                  !r(w[t].y) &&
                  w[t].y.length &&
                  "number" === typeof w[t].y[0] &&
                  "number" === typeof w[t].y[1] &&
                  "number" === typeof w[t].y[2] &&
                  "number" === typeof w[t].y[3])
              ) {
                ...
                var A = (h - l / 2) << 0,
                  ...
                  e = w[t].color ? w[t].color : s._colorSet[0],
                  J = Math.round(Math.max(1, 0.15 * l)),
                  z = 0 === J % 2 ? 0 : 0.5,
                  C = s.dataPointIds[t];
                ...
                "candlestick" === s.type
                  ? (c.moveTo(h - z, m),
                    c.lineTo(h - z, Math.min(k, q)),
                    c.stroke(),
                    c.moveTo(h - z, Math.max(k, q)),
                    c.lineTo(h - z, n),
                    c.stroke(),
                    $(
                      c,
                      ...
                      B,
                      Math.max(k, q),
                      w[t].y[0] <= w[t].y[3] ? s.risingColor : g,
                      J,
                      e,
                      v,
                      v,
                    ...
                    u &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(h - z, m),
                      b.lineTo(h - z, Math.min(k, q)),
                      b.stroke(),
                      b.moveTo(h - z, Math.max(k, q)),
                      b.lineTo(h - z, n),
                      b.stroke(),
                      $(
                        b,
                ...
                (w[t].indexLabel ||
                  s.indexLabel ||
                  w[t].indexLabelFormatter ||
                  s.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: s.type,
                    dataPoint: w[t],
                    dataSeries: s,
                    point: { x: A + (B - A) / 2, y: a.axisY.reversed ? n : m },
                    direction: 1,
                    bounds: {
                      x1: A,
                      y1: Math.min(m, n),
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var y = !1, y = !!a.axisY.reversed, x = 0;
          ...
          if (0 < v.length)
            for (
              var A = 5 < l && w.bevelEnabled ? !0 : !1, p = 0;
              p < v.length;
              p++
            )
              if (
                (v[p].getTime ? (f = v[p].x.getTime()) : (f = v[p].x),
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax
                ) &&
                  !r(v[p].y) &&
                  v[p].y.length &&
                  "number" === typeof v[p].y[0] &&
                  "number" === typeof v[p].y[1] &&
                  "number" === typeof v[p].y[2] &&
                  "number" === typeof v[p].y[3] &&
                  "number" === typeof v[p].y[4] &&
                  5 === v[p].y.length)
              ) {
                t = a.axisX.convertValueToPixel(f);
                h = a.axisY.convertValueToPixel(v[p].y[0]);
                ...
                var B = (t - l / 2) << 0,
                  z = (t + l / 2) << 0,
                  e = v[p].color ? v[p].color : w._colorSet[0],
                  ...
                  N = v[p].whiskerColor
                    ...
                    : e,
                  U =
                    "number" === typeof v[p].whiskerThickness
                      ? v[p].whiskerThickness
                      : "number" === typeof w.options.whiskerThickness
                      ? w.whiskerThickness
                      : C,
                  fa = v[p].whiskerDashType
                    ? v[p].whiskerDashType
                    : w.whiskerDashType,
                  ca = r(v[p].whiskerLength)
                    ? r(w.options.whiskerLength)
                      ? l
                      : w.whiskerLength
                    : v[p].whiskerLength,
                  ca =
                  ...
                  oa = v[p].stemColor
                    ...
                    : e,
                  la =
                    "number" === typeof v[p].stemThickness
                      ? v[p].stemThickness
                      : "number" === typeof w.options.stemThickness
                      ? w.stemThickness
                      : C,
                  H = 1 === Math.round(la) % 2 ? 0.5 : 0,
                  G = v[p].stemDashType ? v[p].stemDashType : w.stemDashType,
                  M = v[p].lineColor
                    ? v[p].lineColor
                    : v[p].color
                    ? w.lineColor
                    ...
                    : e,
                  L =
                    "number" === typeof v[p].lineThickness
                      ? v[p].lineThickness
                      : "number" === typeof w.options.lineThickness
                      ? w.lineThickness
                      : C,
                  Q = v[p].lineDashType ? v[p].lineDashType : w.lineDashType,
                  O = 1 === Math.round(L) % 2 ? 0.5 : 0,
                  R = w.upperBoxColor,
                  S = w.lowerBoxColor,
                  ua = r(w.options.fillOpacity) ? 1 : w.fillOpacity,
                  T = w.dataPointIds[p];
                ...
                0 < la &&
                  ...
                  (c.strokeStyle = oa),
                  (c.lineWidth = la),
                  c.setLineDash && c.setLineDash(K(G, la)),
                  c.moveTo(t - H, k),
                  c.lineTo(t - H, h),
                  c.stroke(),
                  c.moveTo(t - H, n),
                ...
                0 < L &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(K(Q, L)),
                  (c.strokeStyle = M),
                  (c.lineWidth = L),
                  c.moveTo(B, q - O),
                  c.lineTo(z, q - O),
                ...
                0 < U &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(K(fa, U)),
                  (c.strokeStyle = N),
                  (c.lineWidth = U),
                  c.moveTo((t - ca / 2) << 0, n - ha),
                  c.lineTo((t + ca / 2) << 0, n - ha),
                  c.stroke(),
                  c.moveTo((t - ca / 2) << 0, h + ha),
                  c.lineTo((t + ca / 2) << 0, h + ha),
                  c.stroke());
                c.restore();
                u &&
                  ((e = Z(T)),
                  ...
                  0 < la &&
                    (b.moveTo(t - E - H, k),
                    b.lineTo(t - E - H, Math.max(h, n)),
                    b.stroke(),
                    b.moveTo(t - E - H, Math.min(h, n)),
                    b.lineTo(t - E - H, m),
                    b.stroke()),
                  $(
                    b,
                  ...
                  0 < U &&
                    (b.beginPath(),
                    (b.lineWidth = U),
                    b.moveTo(t + ca / 2, n - ha),
                    b.lineTo(t - ca / 2, n - ha),
                    b.stroke(),
                    b.moveTo(t + ca / 2, h + ha),
                    b.lineTo(t - ca / 2, h + ha),
                    b.stroke()));
                (v[p].indexLabel ||
                  w.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: v[p],
                    dataSeries: w,
                    point: { x: B + (z - B) / 2, y: a.axisY.reversed ? h : n },
                    direction: 1,
                    bounds: {
                      x1: B,
                      y1: Math.min(h, n),
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < f.length)
            for (
              var l = 5 < k && q.bevelEnabled ? !0 : !1, g = 0;
              g < f.length;
              g++
            )
              if (
                ...
                var y = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + m) * k) <<
                      0,
                  x = a.axisX.reversed ? (y - k) << 0 : (y + k) << 0,
                  b = f[g].color
                    ? f[g].color
                    : q._colorSet[g % q._colorSet.length];
                if (p > t) {
                  var s = p;
                  p = t;
                  t = s;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          if (z)
            for (e = A._linkedSeries.id, s = 0; s < e; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                ...
                (this.data[s].type.match(/(range)/gi) && (g = !0), C++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (z ? x : 1))
              ) << 0
            : 0.3 * this.width;
          g &&
            (t = this.options.dataPointMaxWidth
          ...
          s = this.options.dataPointWidth
            ...
            : (0.9 *
                (((b ? p.height : p.width) *
                  (a.axisX.logarithmic
                    ? Math.log(y) / Math.log(a.axisX.range)
                    : Math.abs(y) / Math.abs(a.axisX.range))) /
                  (z ? x : 1))) <<
              0;
          this.dataPointMaxWidth &&
            e > t &&
          ...
          if (0 < B.length)
            for (var G = A._colorSet, t = 0; t < B.length; t++) {
              var e = (A.lineColor = A.options.color ? A.options.color : G[0]),
                N = {
                  color: B[t].whiskerColor
                    ? B[t].whiskerColor
                    : B[t].color
                    ? A.whiskerColor
                      ? A.whiskerColor
                    ...
                    ? A.whiskerColor
                    : e,
                  thickness: r(B[t].whiskerThickness)
                    ? A.whiskerThickness
                    : B[t].whiskerThickness,
                  dashType: B[t].whiskerDashType
                    ? B[t].whiskerDashType
                    : A.whiskerDashType,
                  length: r(B[t].whiskerLength)
                    ? r(A.options.whiskerLength)
                      ? s
                      : A.options.whiskerLength
                    : B[t].whiskerLength,
                  trimLength: r(B[t].whiskerLength)
                    ? r(A.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var U = {
                color: B[t].stemColor
                  ...
                  ? A.stemColor
                  : e,
                thickness: B[t].stemThickness
                  ? B[t].stemThickness
                  : A.stemThickness,
                dashType: B[t].stemDashType
                  ? B[t].stemDashType
                  : A.stemDashType,
              };
              U.thickness =
                "number" === typeof U.thickness
                  ...
                  : 2;
              B[t].getTime ? (l = B[t].x.getTime()) : (l = B[t].x);
              if (
                !(
                  l < a.axisX.dataInfo.viewPortMin ||
                  l > a.axisX.dataInfo.viewPortMax
                ...
                var fa = a.axisX.convertValueToPixel(l);
                b ? (k = fa) : (h = fa);
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((z ? x : 1) * s) / 2 - (z ? C - 1 : 0) * s) << 0
                      : (k - ((z ? x : 1) * s) / 2 + (z ? C - 1 : 0) * s) << 0),
                    (f = a.axisX.reversed ? (q - s) << 0 : (q + s) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((z ? x : 1) * s) / 2 - (z ? C - 1 : 0) * s) << 0
                      : (h - ((z ? x : 1) * s) / 2 + (z ? C - 1 : 0) * s) << 0),
                ...
                u && E(this._eventManager.ghostCtx, m, q, n, f, e, N, U, b);
                if (
                  B[t].indexLabel ||
                  A.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (B[t].y[1] >= B[t].y[0] ? m : n) : m + (n - m) / 2,
                      y: b ? q + (f - q) / 2 : B[t].y[1] >= B[t].y[0] ? f : q,
                    },
                    direction: B[t].y[1] >= B[t].y[0] ? -1 : 1,
                    bounds: {
                      x1: b ? Math.min(m, n) : m,
                      y1: b ? q : Math.min(q, f),
                      x2: b ? Math.max(m, n) : n,
                      ...
                      point: {
                        x: b
                          ? B[t].y[1] >= B[t].y[0]
                            ...
                            : m
                          : m + (n - m) / 2,
                        y: b ? q + (f - q) / 2 : B[t].y[1] >= B[t].y[0] ? q : f,
                      },
                      direction: B[t].y[1] >= B[t].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, n) : m,
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < l.length) {
            ...
            for (g = 0; g < l.length; g++)
              if (
                (l[g].getTime ? (k = l[g].x.getTime()) : (k = l[g].x),
                !(
                ...
                p = a.axisY.convertValueToPixel(l[g].y[0]);
                t = a.axisY.convertValueToPixel(l[g].y[1]);
                ...
                h = a.axisX.reversed
                  ...
                  : (h -
                      ...
                      (a.previousDataSeriesCount + n) * m) <<
                    0;
                var x = a.axisX.reversed ? (h - m) << 0 : (h + m) << 0;
                p > t && ((b = p), (p = t), (t = b));
                b = l[g].color
                  ? l[g].color
                  : f._colorSet[g % f._colorSet.length];
                $(
                  c,
                  p,
                  a.axisX.reversed ? x : h,
                  t,
                  a.axisX.reversed ? h : x,
                  b,
                  0,
                  null,
                  y,
      ...
      function d() {
        if (w) {
          for (var a = null, c = l.length - 1; 0 <= c; c--)
            (a = l[c]), b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = m.fillOpacity;
          b.fill();
          b.globalAlpha = 1;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          var g = [],
            ...
            w = null;
          if (0 < n.length) {
            var v = m._colorSet[f % m._colorSet.length],
              A = (m.lineColor = m.options.lineColor || v),
              B = A;
            b.fillStyle = v;
            b.strokeStyle = A;
            ...
            if (b.setLineDash) {
              var C = K(m.nullDataLineDashType, m.lineThickness),
                z = m.lineDashType,
                E = K(z, m.lineThickness);
              b.setLineDash(E);
            }
            for (var N = !0; f < n.length; f++)
              if (
                ((s = n[f].x.getTime ? n[f].x.getTime() : n[f].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!m.connectNullData || !N))
                ...
                if (
                  null !== n[f].y &&
                  n[f].y.length &&
                  "number" === typeof n[f].y[0] &&
                  "number" === typeof n[f].y[1]
                ) {
                  r = a.axisX.convertValueToPixel(s);
                  ...
                  q || N
                    ? (m.connectNullData && !q
                        ? (b.setLineDash &&
                            ...
                            ((l[l.length - 1].newLineDashArray = E),
                  ...
                  f < n.length - 1 &&
                    (B !== (n[f].lineColor || A) ||
                      z !== (n[f].lineDashType || m.lineDashType)) &&
                    (d(),
                    (B = n[f].lineColor || A),
                    (l[l.length - 1].newStrokeStyle = B),
                    (b.strokeStyle = B),
                    b.setLineDash &&
                      (n[f].lineDashType
                        ? ((z = n[f].lineDashType),
                  ...
                  if (
                    0 !== n[f].markerSize &&
                    (0 < n[f].markerSize || 0 < m.markerSize)
                  ) {
                    var U = m.getMarkerProperties(f, r, x, b);
                    g.push(U);
                    var fa = Z(s);
                    u &&
                      g.push({
                    ...
                    U = m.getMarkerProperties(f, r, y, b);
                    g.push(U);
                    fa = Z(s);
                    u &&
                      g.push({
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: r, y: y },
                      direction:
                        n[f].y[0] > n[f].y[1] === a.axisY.reversed ? -1 : 1,
                      color: v,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (y[g].newStrokeStyle || y[g].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  y[g].newStrokeStyle && (b.strokeStyle = y[g].newStrokeStyle),
                  y[g].newLineDashArray && b.setLineDash(y[g].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < m.length) {
            ...
            var A = "solid",
              B;
            if (b.setLineDash) {
              var J = K(k.nullDataLineDashType, k.lineThickness),
                A = k.lineDashType;
              B = K(A, k.lineThickness);
            }
            for (f = !1; n < m.length; n++)
              if (
                ...
                if (
                  ...
                  n < m.length - 1 &&
                    ...
                    b.setLineDash &&
                      (m[n].lineDashType
                        ? ((A = m[n].lineDashType),
                          (y[y.length - 1].newLineDashArray = K(
                            A,
                            k.lineThickness
                          )))
                        : ((A = k.lineDashType),
                  ...
                  if (
                    ...
                    var E = k.getMarkerProperties(n, q, f, b);
                    g.push(E);
                    var N = Z(C);
                    u &&
                      g.push({
    ...
    l.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          y.fallingColor = y.options.fallingColor
            ? y.options.fallingColor
            : "#e40a0a";
          var s =
              "number" === typeof y.options.lineThickness
                ? Math.round(y.lineThickness)
                : 1,
            w = 1 === Math.round(s) % 2 ? -0.5 : 0;
          if (0 < x.length)
            for (
              var v = 5 < q && y.bevelEnabled ? !0 : !1,
                A = !1,
                B = null,
                z = null,
                p = 0;
              ...
              if (
                (x[p].getTime ? (m = x[p].x.getTime()) : (m = x[p].x),
                "number" !== typeof x[p].y)
              ) {
                if (0 < p && !A && y.connectNullData)
                  var C =
                    y.options.nullDataLineDashType || !x[p - 1].lineDashType
                      ? y.nullDataLineDashType
                      : x[p - 1].lineDashType;
                A = !0;
              } else {
                h = a.axisX.convertValueToPixel(m);
                l =
                  0 === y.dataPointEOs[p].cumulativeSum
                    ? n
                    : a.axisY.convertValueToPixel(
                        y.dataPointEOs[p].cumulativeSum
                      );
                k =
                  0 === y.dataPointEOs[p].cumulativeSumYStartValue
                    ? n
                    : a.axisY.convertValueToPixel(
                        y.dataPointEOs[p].cumulativeSumYStartValue
                      );
                h = a.axisX.reversed
                  ? (h +
                      (a.plotType.totalDataSeries * q) / 2 -
                      (a.previousDataSeriesCount + f) * q) <<
                    0
                  : (h -
                      (a.plotType.totalDataSeries * q) / 2 +
                      (a.previousDataSeriesCount + f) * q) <<
                ...
                var U,
                  N = h;
                U =
                  ("undefined" !== typeof x[p].isIntermediateSum &&
                    !0 === x[p].isIntermediateSum) ||
                  ("undefined" !== typeof x[p].isCumulativeSum &&
                    !0 === x[p].isCumulativeSum)
                    ? 0 < x[p].y
                      ? l
                      : k
                    : 0 < x[p].y
                ...
                0 < p &&
                  B &&
                  (!A || y.connectNullData) &&
                  (A && c.setLineDash && c.setLineDash(K(C, s)),
                  c.beginPath(),
                  c.moveTo(B, z - w),
                  c.lineTo(N, U - w),
                  0 < s && c.stroke(),
                ...
                N = x[p].lineDashType
                  ? x[p].lineDashType
                  : y.options.lineDashType
                  ? y.options.lineDashType
                  : "shortDash";
                c.strokeStyle = x[p].lineColor
                  ? x[p].lineColor
                  : y.options.lineColor
                  ? y.options.lineColor
                  : "#9e9e9e";
                ...
                (x[p].indexLabel ||
                  y.indexLabel ||
                  x[p].indexLabelFormatter ||
                  y.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: x[p],
                    dataSeries: y,
                    point: { x: h + (E - h) / 2, y: 0 <= x[p].y ? l : k },
    ...
    var qa = function (a, d, c, b, e, g, p, h, l) {
      if (!(0 > c)) {
        ...
        if (k && m) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            n = g.indexLabelFormatter
              ...
              : g.indexLabel
              ? l.replaceKeywordsWithValue(g.indexLabel, g, k, e)
              : k.indexLabelFormatter
              ? k.indexLabelFormatter(t)
              : k.indexLabel
              ? l.replaceKeywordsWithValue(k.indexLabel, g, k, e)
              : g.label
              ? g.label
              : "";
            l._eventManager.objectMap[p] = h;
            h.center = { x: v.x, y: v.y };
            h.y = g.y;
            h.radius = C;
            h.percentInnerRadius = G;
            h.indexLabelText = n;
            ...
            h.indexLabelLineThickness = r(g.indexLabelLineThickness)
            ...
            h.indexLabelFontSize = r(g.indexLabelFontSize)
            ...
            h.indexLabelWrap =
              "undefined" !== typeof g.indexLabelWrap
                ? g.indexLabelWrap
                : k.indexLabelWrap;
            h.indexLabelTextAlign = g.indexLabelTextAlign
              ? g.indexLabelTextAlign
            ...
            h.endAngle = h.startAngle + ((2 * Math.PI) / A) * Math.abs(g.y);
            g = (h.endAngle + h.startAngle) / 2;
            g = (g + 2 * Math.PI) % (2 * Math.PI);
            h.midAngle = g;
            if (h.midAngle > Math.PI / 2 - s && h.midAngle < Math.PI / 2 + s) {
              if (0 === a || f[c].midAngle > h.midAngle) c = e;
              a++;
            } else if (
              h.midAngle > (3 * Math.PI) / 2 - s &&
              h.midAngle < (3 * Math.PI) / 2 + s
            ) {
              if (0 === b || f[d].midAngle > h.midAngle) d = e;
              b++;
            }
            h.hemisphere =
              g > Math.PI / 2 && g <= (3 * Math.PI) / 2 ? "left" : "right";
            h.indexLabelTextBlock = new ka(l.plotArea.ctx, {
      ...
      function c(a) {
        ...
        for (b = 0; b < m.length; b++) {
          var c = f[b].startAngle,
            d = f[b].endAngle;
          if (d > c) {
            var e = 0.07 * C * Math.cos(f[b].midAngle),
              g = 0.07 * C * Math.sin(f[b].midAngle),
              p = !1;
            if (m[b].exploded) {
              if (
                1e-9 < Math.abs(f[b].center.x - (v.x + e)) ||
                1e-9 < Math.abs(f[b].center.y - (v.y + g))
              )
                (f[b].center.x = v.x + e * a),
                  (f[b].center.y = v.y + g * a),
                  (p = !0);
            } else if (
              0 < Math.abs(f[b].center.x - v.x) ||
              0 < Math.abs(f[b].center.y - v.y)
            )
              (f[b].center.x = v.x + e * (1 - a)),
                (f[b].center.y = v.y + g * (1 - a)),
                (p = !0);
            p &&
              ((e = {}),
              (e.dataSeries = k),
          ...
          (c = f[b]),
            c.indexLabelText &&
              ((c.indexLabelTextBlock.y -=
                ...
                c.indexLabelTextBlock.fontSize / 2),
              (d = 0),
              (d =
                "left" === c.hemisphere
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(
                    K(c.indexLabelLineDashType, c.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(d, e),
      ...
      function g(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          ...
          var l = 0,
            ...
            q = (l = l = 0);
          0 > c
            ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > k &&
          ...
          k =
            "right" === n.hemisphere
              ? v.x + Math.sqrt(Math.pow(y, 2) - Math.pow(c - v.y, 2))
              : v.x - Math.sqrt(Math.pow(y, 2) - Math.pow(c - v.y, 2));
          q = v.x + C * Math.cos(n.midAngle);
          l = v.y + C * Math.sin(n.midAngle);
          l = Math.sqrt(Math.pow(k - q, 2) + Math.pow(c - l, 2));
          q = Math.acos(C / y);
          l = Math.acos((y * y + C * C - l * l) / (2 * C * y));
          c = l < q ? c - n.indexLabelTextBlock.y : 0;
          k = null;
          for (h = 1; h < m.length; h++)
            if (
              ((k = (a - h + f.length) % f.length),
              ...
              (0 > b(f[k], f[a]) ||
                ("right" === f[a].hemisphere
                  ? f[k].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y
                  : f[k].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))
            )
              break;
            else k = null;
              ...
              null !== h &&
                ...
                (c =
                  ...
                  (f[h].indexLabelTextBlock.y +
                    f[h].indexLabelTextBlock.height / 2)),
                c - q < u &&
                  ((k = -q),
                  (h = g(h, k, d + 1)),
                  +h.toFixed(w) > +k.toFixed(w) &&
                    (p = c > u ? -(c - u) : -(q - (h - k))))))
            : 0 < c &&
              ((h = "right" === n.hemisphere ? l : q),
              (p = c),
              null !== h &&
                ((q = c),
                (c =
                ...
                c - q < u &&
                  ...
                  +h.toFixed(w) < +k.toFixed(w) &&
                    (p = c > u ? c - u : q - (k - h)))));
          p &&
            ((d = n.indexLabelTextBlock.y + p),
            (c = 0),
            (c =
              "right" === n.hemisphere
                ? v.x + Math.sqrt(Math.pow(y, 2) - Math.pow(d - v.y, 2))
                : v.x - Math.sqrt(Math.pow(y, 2) - Math.pow(d - v.y, 2))),
            n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s
              ? ((k = (a - 1 + f.length) % f.length),
                (k = f[k]),
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (a = 0; a < m.length; a++) {
              var h = f[a];
              h.indexLabelTextBlock.x = v.x + y * Math.cos(h.midAngle);
              h.indexLabelTextBlock.y = v.y + y * Math.sin(h.midAngle);
            ...
            for (var t, r, a = 0; a < m.length; a++) {
              ...
              if (null !== s) {
                ...
                var A = 0,
                  A = b(t, r) - u;
                if (0 > A) {
                  for (var z = (r = 0), B = 0; B < m.length; B++)
                    B !== a &&
                      f[B].hemisphere === h.hemisphere &&
                      (f[B].indexLabelTextBlock.y < h.indexLabelTextBlock.y
                        ? r++
                        : z++);
                  r = (A / (r + z || 1)) * z;
                  var z = -1 * (A - r),
                  ...
                  "right" === h.hemisphere
                    ? ((B = g(a, r)),
                      (z = -1 * (A - B)),
                      (K = g(s, z)),
                      +K.toFixed(w) < +z.toFixed(w) &&
                        +B.toFixed(w) <= +r.toFixed(w) &&
                        g(a, -(z - K)))
                    : ((B = g(s, r)),
                      (z = -1 * (A - B)),
                      (K = g(a, z)),
            ...
            for (a = 0; a < m.length; a++)
              (h = f[a]),
                (y = "pie" === k.type ? 0.7 * C : 0.85 * C),
                (s = v.x + y * Math.cos(h.midAngle)),
                (r = v.y + y * Math.sin(h.midAngle)),
                  ...
                  (!p &&
                    ...
                    ((r =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === g(a, s * r) && g(a, 2 * r)),
                  Math.abs(h.indexLabelTextBlock.x - v.x) < C &&
          ...
          (function () {
            for (var a = -1, c = -1, d = 0, g = !1, p = 0; p < m.length; p++)
              if (((g = !1), (t = f[p]), t.indexLabelText)) {
                var k = e(p);
                if (null !== k) {
                  var h = f[k];
                  A = 0;
                  ...
                  if ((l = 0 > A)) {
                    ...
                    var q =
                      ...
                      s =
                        h.indexLabelTextBlock.y -
                        h.indexLabelTextBlock.height / 2,
                      D = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width,
                      v =
                        h.indexLabelTextBlock.y +
                        h.indexLabelTextBlock.height / 2;
                    l =
                  ...
                  l
                    ? (0 > a && (a = p),
                      k !== a && ((c = k), (d += -A)),
                      0 === p % Math.max(m.length / 10, 3) && (g = !0))
                    : (g = !0);
                  g &&
                    0 < d &&
                    0 <= a &&
    ...
    l.prototype.renderFunnel = function (a) {
      function d() {
        ...
        if (0 === a) return -1;
        for (c = b[0] = 0; c < w.length; c++)
          b.push((Math.abs(w[c].y) * E) / a);
        return b;
      }
      function c() {
        var a = V,
        ...
        f = Math.abs(f);
        f = d + f;
        for (var d = [], g = 0, p = 0; p < w.length; p++) {
          if ("undefined" === typeof w[p].y) return -1;
          w[p].y = "number" === typeof w[p].y ? w[p].y : 0;
          g += Math.abs(w[p].y);
        }
        if (0 === g) return -1;
        for (
          var k = (d[0] = 0), h = 0, m, n, b = b - a, k = !1, p = 0;
          p < w.length;
          p++
        )
          (a = (Math.abs(w[p].y) * f) / g),
            k
              ? (m = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((n = ba * ba * b * b - 4 * Math.abs(ba) * a),
                0 > n
                  ? ((n = c),
                    (k = ((b + n) * (e - h)) / 2),
                    (a -= k),
      ...
      function b() {
        if (s && w) {
          for (
            ...
            (D = T[F]),
              (D =
                "undefined" !== typeof D.x5
                  ? (D.y2 + D.y4) / 2
                  : (D.y2 + D.y3) / 2),
              (D = f(D).x2 + 1),
              (v[F] = L - D - Z);
          D = 0.5 * Z;
          for (var F = 0, B = w.length - 1; F < w.length || 0 <= B; F++, B--) {
            b = s.reversed ? w[B] : w[F];
            a = b.color
              ? b.color
              : s.reversed
              ? s._colorSet[(w.length - 1 - F) % s._colorSet.length]
              : s._colorSet[F % s._colorSet.length];
            ...
            g = r(b.indexLabelFontSize)
              ? s.indexLabelFontSize
              : b.indexLabelFontSize;
            p = b.indexLabelFontStyle || s.indexLabelFontStyle || "normal";
            ...
            y[F] =
              "inside" === s.indexLabelPlacement
                ? l
                  ? Math.max(T[F].height, g)
                  : 1.5 * g
                : !1;
            A = x.getPercentAndTotal(s, b);
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? x.replaceKeywordsWithValue(b.indexLabel, b, s, F)
              : s.indexLabelFormatter
              ? s.indexLabelFormatter(z)
              : s.indexLabel
              ? x.replaceKeywordsWithValue(s.indexLabel, b, s, F)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
            1e3 > q && 1e3 - q < D && (q += 1e3 - q);
            R.roundRect || Aa(R);
            c = new ka(R, {
              fontSize: g,
              fontFamily: k,
              ...
              backgroundColor: d,
              maxWidth: q,
              maxHeight: !1 === y[F] ? (l ? 4.28571429 * g : 1.5 * g) : y[F],
              text: b,
              padding: ea,
              textBaseline: "middle",
            });
      ...
      function e() {
        ...
        for (
          ...
          c = I[k];
          d = c.textBlock;
          b = (a = q(k) < T.length ? I[q(k)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + ea > b.y && (e = !0);
          c = g.indexLabelMaxWidth || p;
          if (c > p || 0 > c) c = p;
          f.push(c);
        }
        if (e)
          for (k = I.length - 1; 0 <= k; k--)
            (a = T[k]),
              ...
              (I[k].textBlock.height =
                I[k].textBlock.height === 2 * I[k].textBlock.padding
                  ? 0
                  : I[k].textBlock.height),
              (I[k].textBlock.width =
                I[k].textBlock.width === 2 * I[k].textBlock.padding
                  ? 0
                  : I[k].textBlock.width),
              (I[k].textBlock.x = L - p),
              (c =
              ...
              s.reversed
                ? (I[k].textBlock.y + I[k].height > W + A &&
                    (I[k].textBlock.y = W + A - I[k].height),
                  I[k].textBlock.y < ua - A && (I[k].textBlock.y = ua - A))
                : (I[k].textBlock.y < W - A && (I[k].textBlock.y = W - A),
                  I[k].textBlock.y + I[k].height > ua + A &&
                    (I[k].textBlock.y = ua + A - I[k].height));
      }
      function g() {
        var a, b, c, d;
          ...
          for (var e = 0; e < T.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = T[e]),
                ...
                s.reversed
                  ? (I[e].textBlock.y + I[e].height > W + A &&
                      (I[e].textBlock.y = W + A - I[e].height),
                    I[e].textBlock.y < ua - A && (I[e].textBlock.y = ua - A))
                  : (I[e].textBlock.y < W - A && (I[e].textBlock.y = W - A),
                    I[e].textBlock.y + I[e].height > ua + A &&
                      (I[e].textBlock.y = ua + A - I[e].height)));
        else
      ...
      function p() {
        function a(b, c) {
          ...
          d = h(b, e);
          if (d >= c) return (f.y += c), c;
          if (b == T.length - 1) return 0 < d && (f.y += d), d;
          d += a(e, c - d);
          0 < d && (f.y += d);
          return d;
        }
        function b() {
          ...
          for (var p, h = 1; h < k; h++) {
            ...
            for (var l = I.length - 1; 0 <= l; l--)
              !I[l].isDirty &&
                I[l].textBlock.y < e &&
                I[l].textBlock.y + I[l].height > e &&
                ((p = q(l)),
                !(p >= I.length - 1) &&
                  I[l].textBlock.y + I[l].height + ea > I[p].textBlock.y &&
                  (I[l].textBlock.y =
                    I[l].textBlock.y + I[l].height - e > e - I[l].textBlock.y
                      ? e + 1
                      : e - I[l].height - 1));
          }
          for (p = T.length - 1; 0 < p; p--)
            if (!I[p].isDirty) {
              ...
              if (I[p].textBlock.y < I[e].textBlock.y + I[e].height) {
                ...
                for (
                  k = 0;
                  I[f].textBlock.y < I[e].textBlock.y + I[e].height + ea;
        ...
        function c(a, b, d) {
          var e = [],
            f = 0,
            g = 0;
          for (a = Math.abs(a); d <= b; d++) e.push(T[d]);
          e.sort(function (a, b) {
        ...
        for (var d, e, f, g, k, p, m = 1, l = 0; l < 2 * m; l++) {
          for (
            var r = I.length - 1;
            0 <= r &&
            !(0 <= n(r) && n(r),
            (f = I[r]),
            (g = f.textBlock),
            (p = (k = q(r) < T.length ? I[q(r)] : null) ? k.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              k &&
              e + d + ea > +p.y.toFixed(6) &&
              ((d = g.y + d + ea - p.y),
              (e = a(r, -d)),
      ...
      function h(a, b) {
        return (
          (b < T.length ? I[b].textBlock.y : s.reversed ? W + A : ua + A) -
          (0 > a
            ? s.reversed
              ? ua - A
              : W - A
            : I[a].textBlock.y + I[a].height + ea)
        );
      }
      function l(a, b, c) {
        var d,
        ...
        if (0 === aa.length) p = ja;
          ...
          e =
            (A *
              (1 != aa.length || (0 != aa[0] && aa[0] != T.length - 1)
                ? 2
                : 1)) /
            k();
          for (var q = 0; q < T.length; q++) {
            ...
            p.push(ja[q] + d);
            if (0 <= aa.indexOf(q) || (q < T.length && 0 <= aa.indexOf(q + 1)))
              d += e;
          }
        }
        f = (function () {
          for (var a = [], b = 0; b < T.length; b++) a.push(p[b] - T[b].y1);
          return a;
        })();
        var t = {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            e.dataPoint = s.reversed
              ? s.dataPoints[w.length - 1 - b]
              : s.dataPoints[b];
            e.index = s.reversed ? w.length - 1 - b : b;
            a.toolTip.highlightObjects([e]);
            for (e = 0; e < T.length; e++) sa(d, T[e], s.fillOpacity);
            y(d);
            N && ("inside" !== s.indexLabelPlacement ? m(d) : g(), z(d));
            1 <= c && (ia = !1);
          },
          null,
          P.easing.easeOutQuart
        );
      }
      function k() {
        for (var a = 0, b = 0; b < T.length - 1; b++)
          (0 <= aa.indexOf(b) || 0 <= aa.indexOf(b + 1)) && a++;
        return a;
      }
      function m(a) {
        for (var b, c, d, e, g = 0; g < T.length; g++)
          (e = 1 === I[g].lineThickness % 2 ? 0.5 : 0),
            (c = (((T[g].y2 + T[g].y4) / 2) << 0) + e),
            (b = f(c).x2 - 1),
            (d = I[g].textBlock.x),
            (e = ((I[g].textBlock.y + I[g].height / 2) << 0) + e),
            I[g].isDirty ||
              0 == I[g].lineThickness ||
              ((a.strokeStyle = I[g].lineColor),
              (a.lineWidth = I[g].lineThickness),
              a.setLineDash &&
                a.setLineDash(K(I[g].lineDashType, I[g].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      function z(a) {
        for (var b = 0; b < T.length; b++)
          I[b].isDirty ||
            (a && (I[b].textBlock.ctx = a),
            (I[b].textBlock.y += I[b].textBlock._lineHeight / 2),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var s = this.data[a.dataSeriesIndexes[0]],
            ...
            C = 0,
            E = v.height - 2 * A,
            G = Math.min(v.width - 2 * B, 2.8 * v.height),
            N = !1,
            U = 0;
          U < w.length;
          U++
          ...
          if (
            (!N &&
              "undefined" !== typeof w[U].indexLabel &&
              null !== w[U].indexLabel &&
              0 < w[U].indexLabel.toString().length &&
              (N = !0),
            !N &&
              "undefined" !== typeof w[U].label &&
              null !== w[U].label &&
              0 < w[U].label.toString().length &&
              (N = !0),
            (!N && "function" === typeof s.indexLabelFormatter) ||
              "function" === typeof w[U].indexLabelFormatter)
          )
            N = !0;
        N =
          N ||
        ...
        ("inside" !== s.indexLabelPlacement && N) ||
          (B = (v.width - 0.75 * G) / 2);
        var U = v.x1 + B,
          L = v.x2 - B,
          M = v.y1 + A,
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== w.length) {
          ...
          var Z = (30 * (L - a)) / 100;
          "funnel" === s.type
            ? ((S = r(s.options.neckHeight) ? 0.35 * E : s.neckHeight),
              (H = r(s.options.neckWidth) ? 0.25 * a : s.neckWidth),
              "string" === typeof S && S.match(/%$/)
                ? ((S = parseInt(S)), (S = (S * E) / 100))
                : (S = parseInt(S)),
              "string" === typeof H && H.match(/%$/)
                ? ((H = parseInt(H)), (H = (H * a) / 100))
                : (H = parseInt(H)),
              S > E ? (S = E) : 0 >= S && (S = 0),
              H > a ? (H = a - 0.5) : 0 >= H && (H = 0))
            : "pyramid" === s.type &&
              ((H = S = 0), (s.reversed = s.reversed ? !1 : !0));
          var B = U + a / 2,
            V = U,
            X = U + a,
            W = s.reversed ? Q : M,
          ...
          if (-1 !== U) {
            if (s.reversed)
              for (G.push($), H = U.length - 1; 0 < H; H--)
                ($ += U[H]), G.push($);
            else for (H = 0; H < U.length; H++) ($ += U[H]), G.push($);
            if (s.reversed)
              for (H = 0; H < U.length; H++)
                G[H] < Ea
                  ? (a.push(O), B.push(Y), (da = H))
                  : (a.push((G[H] - W + ba * V) / ba),
                    B.push((G[H] - W + ga * X) / ga));
            else
              for (H = 0; H < U.length; H++)
                G[H] < Ea
                  ? (a.push((G[H] - W + ba * V) / ba),
            ...
            for (H = 0; H < U.length - 1; H++)
              ($ = s.reversed
                ? w[w.length - 1 - H].color
                  ? w[w.length - 1 - H].color
                  : s._colorSet[(w.length - 1 - H) % s._colorSet.length]
                : w[H].color
                ? w[H].color
                : s._colorSet[H % s._colorSet.length]),
                H === da
                  ? T.push({
                      x1: a[H],
                      y1: G[H],
            ...
            for (H = 0; H < w.length; H++)
              w[H].exploded &&
                ((U = !0), s.reversed ? aa.push(w.length - 1 - H) : aa.push(H));
            ...
            if (
              N &&
              s.visible &&
              (b(), g(), "inside" !== s.indexLabelPlacement)
            ) {
              e();
              p();
              for (H = 0; H < w.length; H++)
                I[H].isDirty ||
                  ((a = I[H].textBlock.x + I[H].width),
                  (a = (L - a) / 2),
                  0 == H && (C = a),
                  C > a && (C = a));
              for (H = 0; H < T.length; H++)
                (T[H].x1 += C),
                  ...
                  (T[H].x3 += C),
                  (T[H].x4 += C),
                  T[H].x5 && ((T[H].x5 += C), (T[H].x6 += C)),
                  (I[H].textBlock.x += C);
            }
            for (H = 0; H < T.length; H++)
              (C = T[H]), sa(R, C, s.fillOpacity), ja.push(C.y1);
            y(R);
            N &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || x.animationEnabled || m(R),
              x.animationEnabled || z());
            if (!N)
              for (H = 0; H < w.length; H++)
                (C = s.dataPointIds[H]),
                  (a = {
                    ...
                    dataPointIndex: H,
                    dataSeriesIndex: 0,
                    funnelSection: T[s.reversed ? w.length - 1 - H : H],
                  }),
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                if ("funnel" === s.type || "pyramid" === s.type)
                  s.reversed
                    ? (w[w.length - 1 - a].exploded = w[w.length - 1 - a]
                        .exploded
                        ? !1
                        : !0)
                    : (w[a].exploded = w[a].exploded ? !1 : !0);
                l(x, b, 500);
              }
            };
            return {
              ...
              animationCallback: function (a, b) {
                P.fadeInAnimation(a, b);
                1 <= a && (l(x, -1, 500), y(x.plotArea.ctx || x.ctx));
              },
              easingFunction: P.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace("#percent", ea(p, l, g._cultureInfo));
          a = a.replace(
            "#total",
            ea(
              h,
    ...
    M.prototype.setLayout = function () {
          ...
          if (
            ...
            var q = (n.legendMarkerType = n.legendMarkerType
              ...
              f = n.legendText
                ...
                : n.name,
              u = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                ? n.markerColor
                : "error" === n.type
            ...
            for (var w = 0; w < n.dataPoints.length; w++) {
              var v = n.dataPoints[w],
                ...
                u = v.legendMarkerColor
                  ...
                  : n.color
                  ? n.color
                  : n._colorSet[w % n._colorSet.length],
                ...
                s = v.legendMarkerBorderThickness
                  ...
                  ? Math.max(1, Math.round(0.2 * y))
                  : 0,
                f = this.chart.replaceKeywordsWithValue(f, v, n, w),
                q = {
                  markerType: q,
                  markerColor: u,
                  text: f,
      ...
      if (0 < l.length) {
        ...
        v = (this.itemMaxWidth ? this.itemMaxWidth : v) - (y + h);
    ...
    M.prototype.render = function () {
      ...
      for (var h = 0, l = 0; l < p.length; l++) {
        for (var k = p[l], m = 0, n = 0; n < k.items.length; n++) {
          var q = k.items[n],
            f =
              q.textBlock.x + a + (0 === n ? 0.2 * g : this.horizontalSpacing),
            r = d + h,
            u = f;
          ...
          this.ghostCtx.fillRect(
            ...
            q.textBlock.x + q.textBlock.width - u,
            q.textBlock.height ? q.textBlock.height : this.lineHeight
          );
          q.x1 = this.chart._eventManager.objectMap[q.id].x1 = u;
        ...
        if (0 <= g && g < this.dataPoints.length) {
          var b = this.dataPoints[g],
            n = this.axisX.logarithmic
              ...
              : Math.abs(b.x - a);
          n < c.distance &&
            ((c.dataPoint = b), (c.distance = n), (c.index = g));
          b = n;
          b <= h ? (h = b) : 0 < p ? l++ : k++;
        ...
        if (0 <= g && g < this.dataPoints.length) {
          ...
          if (q) {
            switch (this.type) {
              ...
              case "splineArea":
              case "scatter":
                var y = na("markerSize", f, this) || 4,
                  x = c ? 20 : y,
                  u = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                u <= x &&
                  b.push({
                    dataPoint: f,
                    dataPointIndex: g,
              ...
              case "doughnut":
                ...
                x =
                  "doughnut" === this.type
                    ...
                    : 0;
                u = Math.sqrt(Math.pow(y.x - a, 2) + Math.pow(y.y - d, 2));
                u < q.radius &&
                  u > x &&
                  ((u = Math.atan2(d - y.y, a - y.x)),
                  0 > u && (u += 2 * Math.PI),
                  (u = Number(
              ...
              case "pyramid":
                ...
                d > u.y1 &&
                  ...
                  (u.y6
                    ? d > u.y6
                      ? ((g =
                          u.x6 + ((u.x5 - u.x6) / (u.y5 - u.y6)) * (d - u.y6)),
                        (u =
                          u.x3 + ((u.x4 - u.x3) / (u.y4 - u.y3)) * (d - u.y3)))
                      : ((g =
                          u.x1 + ((u.x6 - u.x1) / (u.y6 - u.y1)) * (d - u.y1)),
                        (u =
                          u.x2 + ((u.x3 - u.x2) / (u.y3 - u.y2)) * (d - u.y2)))
                    : ((g =
                        u.x1 + ((u.x4 - u.x1) / (u.y4 - u.y1)) * (d - u.y1)),
                      (u =
                        u.x2 + ((u.x3 - u.x2) / (u.y3 - u.y2)) * (d - u.y2))),
                  a > g &&
                    a < u &&
    ...
    C.prototype.createLabels = function () {
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
                    ...
                    if (r(this.options.labelWrap))
                      if (!r(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          ((0 === y &&
                            q +
                              this._labels[y + 1].textBlock.measureText()
                                .width -
                              2 * g >
                              n) ||
                            (y === this._labels.length - 1 &&
                              q +
                                this._labels[y - 1].textBlock.measureText()
                                  .width -
                                2 * g >
          ...
          if (
            ((g = r(this.options.labelMaxWidth)
              ? (0.3 * this.chart.width) >> 0
              : this.options.labelMaxWidth),
            (p =
              "undefined" === typeof this.options.labelWrap || this.labelWrap
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === g.labelPlacement) {
          ...
          (p =
            ...
            (x =
              r(g.options.labelWrap) || g.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            r(g.labelBackgroundColor) &&
              (r(g.startValue) && 0 !== g.startValue
                ? (g.labelBackgroundColor = u ? "transparent" : null)
        ...
        a = new ka(this.ctx, {
          ...
          maxWidth: g.options.labelMaxWidth ? g.options.labelMaxWidth : p,
          maxHeight: x,
          angle: this.labelAngle,
    ...
    C.setLayout = function (a, d, c, b, e, g) {
      ...
      for (f = 0; f < q.length; f++)
        if (q[f] && q[f].scaleBreaks && q[f].scaleBreaks._appliedBreaks.length)
          for (
            var u = q[f].scaleBreaks._appliedBreaks, y = 0;
            y < u.length && !(u[y].startValue > q[f].viewportMaximum);
            y++
          )
            u[y].endValue < q[f].viewportMinimum ||
              (r(q[f].scaleBreaks.firstBreakIndex) &&
                (q[f].scaleBreaks.firstBreakIndex = y),
              u[y].startValue >= q[f].viewPortMinimum &&
                (q[f].scaleBreaks.lastBreakIndex = y));
      for (
        var x = (y = 0),
          s = 0,
          w = 0,
        ...
        q[f] &&
          q[f].title &&
          (q[f]._titleTextBlock = new ka(q[f].ctx, {
            text: q[f].title,
            horizontalAlign: "center",
        ...
        if (q[f].title)
          switch (q[f]._position) {
            case "left":
              ...
              q[f]._titleTextBlock.maxHeight = q[f].titleWrap
                ? 0.8 * g.width
                : 1.5 * q[f].titleFontSize;
            ...
            case "right":
              ...
              break;
            default:
              (q[f]._titleTextBlock.maxWidth = q[f].titleMaxWidth || g.width),
                (q[f]._titleTextBlock.maxHeight = q[f].titleWrap
                  ? 0.8 * g.height
                  : 1.5 * q[f].titleFontSize),
      ...
      if ("normal" === e) {
        for (
          ...
          l = Math.round(
            g.x2 - ba - aa > m.width - n ? m.width - n : g.x2 - ba - aa
          );
          if (a && 0 < a.length)
            for (w = [], f = Y = 0; f < a.length; f++)
              a[f] && (a[f].lineCoordinates = {}),
                (a[f].lineCoordinates.width = Math.abs(l - p)),
                a[f].title &&
                ...
                (Y += w[f]),
                (e += a[f] && !m.isNavigator ? a[f].margin : 0);
          else
          ...
          if (d && 0 < d.length)
            for (v = [], f = $ = 0; f < d.length; f++)
              d[f] && (d[f].lineCoordinates = {}),
                (d[f].lineCoordinates.width = Math.abs(l - p)),
                d[f].title &&
                ...
                ($ += v[f]),
                (X += d[f] && !m.isNavigator ? d[f].margin : 0);
          else
            ...
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                !a[f] ||
                  ...
                  0 < a[f].labelAngle
                    ? E + s > l &&
                      (h += 0 < a[f].labelAngle ? E + s - l - ba : 0)
                    : 0 > a[f].labelAngle
                    ? C - x < p &&
                      C - x < a[f].viewportMinimum &&
                      (G =
                        p -
                        (O +
                          a[f].tickLength +
          ...
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              (d[f].lineCoordinates.x1 = Math.round(g.x1 + T + O)),
                ...
                d[f]._labels &&
                  ...
                  (s =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                m.panEnabled
                  ? ($ = r(m.sessionVariables.axisX2.height)
                      ? (m.sessionVariables.axisX2.height = $)
                      : m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = $),
                (h = Math.round(g.y1)),
                (k = d[f].lineCoordinates.y1 = h + $ + X - Z),
                (d[f].lineCoordinates.y2 = h),
                "inside" === d[f].labelPlacement &&
                  0 < f &&
                  (d[f].lineCoordinates.y1 =
                    d[f - 1].lineCoordinates.y1 -
                    Z -
                    (d[f].labelEffectiveHeight || 0)),
                "inside" === d[f].tickPlacement &&
                  0 < f &&
                  (d[f].lineCoordinates.y1 -= d[f].tickLength),
                (d[f].bounds = {
                  x1: p,
                  y1: h + ($ + X - v[f] - Z),
                  x2: l,
              ...
              b[f] &&
                ...
                (O =
                  b[f]._labels && 0 < b[f]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  g.y1 + $ + X < Math.max(O, n) ? Math.max(O, n) : g.y1 + $ + X
                )),
                (O =
                  0 < a.length
                    ? 0
            ...
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (p = a[f].getApparentDifference(a[f].viewportMinimum, p)),
                  (E = a[f].logarithmic
                    ? (1 < p
                        ? (Math.log(p) /
                            a[f].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < p
                        ? p * Math.abs(a[f].conversionParameters.pixelPerUnit)
                        : 0) + a[f].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  (p = d[f].getApparentDifference(d[f].viewportMinimum, p)),
                  (E = d[f].logarithmic
                    ? (1 < p
                        ? (Math.log(p) /
                            d[f].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < p
                        ? p * Math.abs(d[f].conversionParameters.pixelPerUnit)
                        : 0) + d[f].lineCoordinates.x1));
          for (f = 0; f < q.length; f++)
            "axisY" === q[f].type &&
        ...
        P = [];
        for (S = []; 4 > y; ) {
          Y = W = V = aa = O = X = e = R = Q = H = $ = 0;
          if (a && 0 < a.length)
            for (G = [], f = W = 0; f < a.length; f++)
              G.push(
          ...
          if (c && 0 < c.length)
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                ...
                (l = Math.round(
                  g.x2 - Y - X > m.width - 10 ? m.width - 10 : g.x2 - Y - X
                )),
                c[f].labelAutoFit &&
                  !r(w) &&
                  (0 < !a.length &&
                  ...
                  0 < !d.length &&
                    (l =
                      0 < c[f].labelAngle
                        ...
                        ? l - v / 2
                        : l)),
                (c[f].lineCoordinates.x1 = p),
                (c[f].lineCoordinates.x2 = l),
                (c[f].lineCoordinates.width = Math.abs(l - p)),
                c[f].title &&
                  (c[f]._titleTextBlock.maxWidth =
                    0 < c[f].titleMaxWidth &&
                  ...
                  (0 < !a.length &&
                    (p =
                      0 < b[f].labelAngle
                        ...
                        : p),
                  0 < !d.length && (l -= B / 2)),
                (b[f].lineCoordinates.x1 = p),
                (b[f].lineCoordinates.x2 = l),
                (b[f].lineCoordinates.width = Math.abs(l - p)),
                b[f].title &&
                  (b[f]._titleTextBlock.maxWidth =
                    0 < b[f].titleMaxWidth &&
          ...
          if (m.panEnabled)
            for (f = 0; f < c.length; f++)
              n[f] = r(m.sessionVariables.axisY[f].height)
                ? (m.sessionVariables.axisY[f].height = n[f])
                : m.sessionVariables.axisY[f].height;
          else
            for (f = 0; f < c.length; f++)
              m.sessionVariables.axisY[f].height = n[f];
          if (c && 0 < c.length)
            for (f = c.length - 1; 0 <= f; f--)
              (h = Math.round(g.y2)),
                (k = Math.round(
                  g.y2 > c[f].chart.height ? c[f].chart.height : g.y2
                )),
          ...
          if (b && 0 < b.length)
            for (f = b.length - 1; 0 <= f; f--)
              b[f] &&
                ((h = Math.round(g.y1)),
                (k = Math.round(g.y1 + (C[f] + b[f].margin + H))),
            ...
            for (f = 0; f < a.length; f++) {
              ...
              h =
                b && 0 < b.length
                  ...
                  ? Math.max(O, 10)
                  : g.y1;
              l = Math.round(g.x1 + W + e);
              k =
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ? c[0].lineCoordinates.y1
                        : g.y2 - V > m.height - Math.max(O, 10)
                        ? m.height - Math.max(O, 10)
                        : g.y2 - V
                    )
                  : g.y2 > m.height - Math.max(O, 10)
                  ? m.height - Math.max(O, 10)
                  : g.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (O = 0; O < b.length; O++)
                  b[O] &&
                    b[O].labelAutoFit &&
                    ((l = b[O].lineCoordinates.x1), (p = l - W));
              a[f].lineCoordinates = {
                x1: l - Q,
                y1: h,
                x2: l - Q,
            ...
            for (f = 0; f < d.length; f++) {
              ...
              if (b && 0 < b.length)
                for (O = 0; O < b.length; O++)
                  b[O] &&
                    b[O].labelAutoFit &&
                    ((l = b[O].lineCoordinates.x2), (p = l - Y));
              d[f].lineCoordinates = {
                x1: l + R,
                y1: h,
                x2: l + R,
              ...
              "inside" === d[f].labelPlacement &&
                ...
                ((d[f].lineCoordinates.x1 =
                  d[f].lineCoordinates.x1 +
                  (x[f] -
                    (d[f]._titleTextBlock ? d[f]._titleTextBlock.height : 0) -
                    2) -
                  d[f].tickLength -
                  (d[f].stripLineLabelEffectiveWidth || 0)),
                (d[f].lineCoordinates.x2 =
                  d[f].lineCoordinates.x1 + d[f].lineThickness / 2));
              "inside" === d[f].tickPlacement &&
                0 < f &&
                ((d[f].lineCoordinates.x1 += d[f].tickLength),
                (d[f].lineCoordinates.x2 =
                  d[f].lineCoordinates.x1 + d[f].lineThickness / 2));
              d[f].bounds = {
    ...
    C.render = function (a, d, c, b, e) {
      ...
      e.clip();
      if (a && 0 < a.length)
        for (var h = 0; h < a.length; h++) a[h].renderLabelsTicksAndTitle();
      if (d && 0 < d.length)
        for (h = 0; h < d.length; h++) d[h].renderLabelsTicksAndTitle();
      e.restore();
      if (c && 0 < c.length)
        for (h = 0; h < c.length; h++) c[h].renderLabelsTicksAndTitle();
      if (b && 0 < b.length)
        for (h = 0; h < b.length; h++) b[h].renderLabelsTicksAndTitle();
      g.preparePlotArea();
      g = g.plotArea;
      e.save();
      e.beginPath();
      ...
      if (a && 0 < a.length)
        for (h = 0; h < a.length; h++) a[h].renderInterlacedColors();
      if (d && 0 < d.length)
        for (h = 0; h < d.length; h++) d[h].renderInterlacedColors();
      if (c && 0 < c.length)
        for (h = 0; h < c.length; h++) c[h].renderInterlacedColors();
      if (b && 0 < b.length)
        for (h = 0; h < b.length; h++) b[h].renderInterlacedColors();
      e.restore();
      if (a && 0 < a.length)
        for (h = 0; h < a.length; h++)
          a[h].renderGrid(),
            u && (a[h].createMask(), a[h].renderBreaksBackground());
      if (d && 0 < d.length)
        for (h = 0; h < d.length; h++)
          d[h].renderGrid(),
            u && (d[h].createMask(), d[h].renderBreaksBackground());
      if (c && 0 < c.length)
        for (h = 0; h < c.length; h++)
          c[h].renderGrid(),
            u && (c[h].createMask(), c[h].renderBreaksBackground());
      if (b && 0 < b.length)
        for (h = 0; h < b.length; h++)
          b[h].renderGrid(),
            u && (b[h].createMask(), b[h].renderBreaksBackground());
      if (a && 0 < a.length)
        for (h = 0; h < a.length; h++) a[h].renderAxisLine();
      if (d && 0 < d.length)
        for (h = 0; h < d.length; h++) d[h].renderAxisLine();
      if (c && 0 < c.length)
        for (h = 0; h < c.length; h++) c[h].renderAxisLine();
      if (b && 0 < b.length)
        for (h = 0; h < b.length; h++) b[h].renderAxisLine();
      if (a && 0 < a.length)
        for (h = 0; h < a.length; h++)
    ...
    C.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !r(d[g].options.spacing)),
          (d[g].spacing =
            Ua(d[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
      ...
      if ("bottom" === this._position) {
        ...
        this.title &&
          ...
          (this._titleTextBlock.y =
            ...
            this._titleTextBlock.fontSize / 2 -
            1),
        ...
        this.title &&
          ...
          (this._titleTextBlock.x =
            ...
            this._titleTextBlock.width / 2),
          (this._titleTextBlock.y =
            this.bounds.y1 + this._titleTextBlock.fontSize / 2 + 1),
          (this.titleMaxWidth = this._titleTextBlock.maxWidth),
          this._titleTextBlock.render(!0));
        ...
        this.title &&
          (this._titleTextBlock.measureText(),
          (this._titleTextBlock.x =
            this.bounds.x1 + this._titleTextBlock.fontSize / 2 + 1),
          (this._titleTextBlock.y =
        ...
        this.title &&
          (this._titleTextBlock.measureText(),
          (this._titleTextBlock.x =
            this.bounds.x2 - this._titleTextBlock.fontSize / 2 - 1),
          (this._titleTextBlock.y =
            this.lineCoordinates.height / 2 -
            this._titleTextBlock.width / 2 +
            this.lineCoordinates.y1),
    ...
    C.prototype.renderGrid = function () {
      if (this.gridThickness && 0 < this.gridThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(K(this.gridDashType, this.gridThickness));
        if ("bottom" === this._position || "top" === this._position)
          for (b = 0; b < this._labels.length; b++)
    ...
    C.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.setLineDash &&
            d.setLineDash(K(this.lineDashType, this.lineThickness));
          var h =
        ...
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
          if (r(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(h, e),
                d.lineTo(h, this.scaleBreaks._appliedBreaks[l].startPixel + b),
        ...
        for (var g = 0; g < e.length && !(d < e[g].startValue); g++)
          a > e[g].endValue ||
            (a <= e[g].startValue && d >= e[g].endValue
              ? (c = (c / e[g].endValue) * e[g].startValue * e[g].size)
              : a >= e[g].startValue && d >= e[g].endValue
              ? (c =
                  (c / e[g].endValue) *
                  a *
        ...
        if ("axisX" === this.type) {
          ...
          "axisY" === this.type &&
            ...
            0 === e && 0 === g
              ? ((g += 9), (e = 0))
              : 0 === g - e
              ? ((b = Math.min(Math.abs(0.01 * Math.abs(g)), 5)),
                (g += b),
                (e -= b))
              : e > g
              ? ((b = Math.min(
    ...
    C.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h = Math.pow(
        this.logarithmBase,
        C.getNiceNumber(Math.abs(Math.log(h) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = C.getNiceExponent(Math.log(h) / d / (a - 1), !0)),
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ...
              : ((e = this.chart.plotArea.y2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b - n / 2, y1: e, x2: h + n / 2, y2: l }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((b = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - n / 2, x2: h, y2: l + n / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
            ...
            m = (h - r) / a / 2;
            for (q = 0; q < m; q++)
              this.ctx.lineTo(r, k), (k += 2 * g * a), (r += 2 * a), (g *= -1);
            this.ctx.lineTo(r, k);
            k += l - e;
            for (q = 0; q < m + 1; q++)
              this.ctx.lineTo(r, k), (k += 2 * g * a), (r -= 2 * a), (g *= -1);
            this.ctx.lineTo(r + a, k + g * a);
          }
        0 < n && this.ctx.stroke();
        this.ctx.closePath();
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: h, x2: g + d / 2, y2: l });
        else if (
          ...
          (h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: e, y1: h - d / 2, x2: g, y2: l + d / 2 });
        this.ctx.moveTo(e, h);
        this.ctx.lineTo(g, l);
        this.ctx.stroke();
    ...
    da.prototype.render = function (a, d, c) {
      var b,
        e,
        g,
        h,
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var s = 0; s < this.parent.dataSeries.length; s++)
            (x = this.parent.dataSeries[s].getDataPointAtX(y, !0)) &&
              0 <= x.index &&
          ...
          if (
            ...
            for (
              var x = Math.abs(
                  a - this.parent.convertValueToPixel(m[s].dataPoint.y[0])
                ),
                w = 0,
                y = 0;
              y < m.length;
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                for (var v = 0; v < m[y].dataPoint.y.length; v++)
                  (w = Math.abs(
                    a - this.parent.convertValueToPixel(m[y].dataPoint.y[v])
                  )),
                    w < x && ((x = w), (s = y));
              else
                (w = Math.abs(
                  a - this.parent.convertValueToPixel(m[y].dataPoint.y)
                )),
                  w < x && ((x = w), (s = y));
            ...
            for (
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                ...
                (A += m[y].dataPoint.y),
                  (w = Math.abs(a - this.parent.convertValueToPixel(A))),
                  w < x && ((x = w), (s = y));
            ...
            for (
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                ...
                (A += m[y].dataPoint.y),
                  (B = m[y].dataPoint.x.getTime
                    ? m[y].dataPoint.x.getTime()
                    : m[y].dataPoint.x),
                  (B = 100 * (A / m[y].dataSeries.plotUnit.dataPointYSums[B])),
                  (w = Math.abs(a - this.parent.convertValueToPixel(B))),
                  w < x && ((x = w), (s = y));
          else
            for (
              x = Math.abs(
          ...
          if (
            ...
            if (
              ...
              for (y = w = 0; y < v.dataPoint.y.length; y++)
                (w = Math.abs(
                  a - this.parent.convertValueToPixel(v.dataPoint.y[y])
                )),
                  w < x && ((x = w), (b = y));
              l =
                1 === f.lineWidth % 2
                  ? (this.parent.convertValueToPixel(v.dataPoint.y[b]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(v.dataPoint.y[b]) << 0;
              ...
              (l =
                1 === f.lineWidth % 2
                  ? (this.parent.convertValueToPixel(v.dataPoint.y) << 0) + 0.5
            ...
            this.bounds = { x1: b - q / 2, y1: g, x2: e + q / 2, y2: h };
            ...
            this.bounds = { x1: b, y1: g - q / 2, x2: e, y2: h + q / 2 };
            B = !1;
            if (this.parent.labels)
              for (
                m = Math.ceil(this.parent.interval), y = 0;
                y < this.parent.viewportMaximum;
                y += m
              )
                if (this.parent.labels[y]) B = !0;
                else {
                  B = !1;
                  break;
                }
          ...
          if (B) {
            if ("axisX" === this.parent.type)
              for (
                y = this.parent.convertPixelToValue({ x: a }), x = null, s = 0;
                s < this.parent.dataSeries.length;
                s++
              )
                (x = this.parent.dataSeries[s].getDataPointAtX(y, !0)) &&
          ...
          !r(this.parent.dataSeries) &&
            ...
            (y = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
          for (s = 0; s < this.parent.dataSeries.length; s++)
            (x = this.parent.dataSeries[s].getDataPointAtX(y, !0)) &&
              0 <= x.index &&
              ((x.dataSeries = this.parent.dataSeries[s]),
          ...
          if (
            ...
            for (
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                for (v = 0; v < m[y].dataPoint.y.length; v++)
                  (w = Math.abs(
                    d - this.parent.convertValueToPixel(m[y].dataPoint.y[v])
                  )),
                    w < x && ((x = w), (s = y));
              else
                (w = Math.abs(
                  d - this.parent.convertValueToPixel(m[y].dataPoint.y)
                )),
                  w < x && ((x = w), (s = y));
          else if (
            ...
            for (
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                ...
                (A += m[y].dataPoint.y),
                  (w = Math.abs(d - this.parent.convertValueToPixel(A))),
                  w < x && ((x = w), (s = y));
          else if (
              ...
              if (m[y].dataPoint.y && m[y].dataPoint.y.length)
                ...
                (A += m[y].dataPoint.y),
                  (B = m[y].dataPoint.x.getTime
                    ...
                    : m[y].dataPoint.x),
                  (B = 100 * (A / m[y].dataSeries.plotUnit.dataPointYSums[B])),
                  (w = Math.abs(d - this.parent.convertValueToPixel(B))),
                  w < x && ((x = w), (s = y));
          else
            for (
              x = Math.abs(
          ...
          if (
            ...
            for (y = w = 0; y < v.dataPoint.y.length; y++)
              (w = Math.abs(
                d - this.parent.convertValueToPixel(v.dataPoint.y[y])
              )),
                w < x && ((x = w), (b = y));
            u =
              1 === f.lineWidth % 2
                ? (this.parent.convertValueToPixel(v.dataPoint.y[b]) << 0) + 0.5
                : this.parent.convertValueToPixel(v.dataPoint.y[b]) << 0;
            k.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
        ...
        if (
          ...
          (b = e = l = 1 === f.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (g = this.chart.plotArea.y1),
            (h = this.chart.plotArea.y2),
            (this.bounds = { x1: b - q / 2, y1: g, x2: e + q / 2, y2: h });
        else if (
        ...
        f.globalAlpha = n;
        0 < q &&
          (f.moveTo(b, g), f.lineTo(e, h), f.stroke(), (this._hidden = !1));
        f.restore();
        this.value =
    ...
    W.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          var l = [];
          if (this.chart.axisX)
            for (var z = 0; z < this.chart.axisX.length; z++) {
              for (
                var h =
                    "xySwapped" === this.chart.plotInfo.axisPlacement
                      ? this.chart.axisX[z].convertPixelToValue({ y: d })
                      : this.chart.axisX[z].convertPixelToValue({ x: a }),
                  k = null,
                  b = 0;
                b < this.chart.axisX[z].dataSeries.length;
                b++
              )
                (k = this.chart.axisX[z].dataSeries[b].getDataPointAtX(h, c)) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX[z].dataSeries[b]),
                  null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
              k = null;
            }
          if (this.chart.axisX2)
            for (z = 0; z < this.chart.axisX2.length; z++) {
              h =
                "xySwapped" === this.chart.plotInfo.axisPlacement
                  ? this.chart.axisX2[z].convertPixelToValue({ y: d })
                  : this.chart.axisX2[z].convertPixelToValue({ x: a });
              k = null;
              for (b = 0; b < this.chart.axisX2[z].dataSeries.length; b++)
                (k = this.chart.axisX2[z].dataSeries[b].getDataPointAtX(
                  h,
                  c
                )) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX2[z].dataSeries[b]),
                  null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
              k = null;
            }
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if (
          ...
          !1 === g.highlightEnabled ||
            (!0 !== b.highlightEnabled && !0 !== g.highlightEnabled) ||
            ("line" === b.type ||
            "stepLine" === b.type ||
            "spline" === b.type ||
            "scatter" === b.type ||
      ...
      if (
        ...
        for (var l = null, r = "", h = 0; h < a.length; h++) {
          ...
          null === b.toolTipContent ||
            ...
            c.visible &&
              (!0 === this.reversed
                ? ((d = this.chart.replaceKeywordsWithValue(g, b, c, e) + d),
                  h < a.length - 1 && (d = "</br>" + d))
    ...
    W.prototype.showAtX = function (a, d) {
      ...
      if (0 < g.length) {
        ...
        this._entries = g;
        h = "";
        h = this.getToolTipInnerHTML({ entries: g });
        if (null !== h) {
                  ...
                  ? (this.contentDiv.style.borderRightColor =
                      ...
                      this.contentDiv.style.borderColor =
                        this.options.borderColor
                          ...
                          ? g[0].dataSeries.color
                          : g[0].dataSeries._colorSet[
                              c.index % g[0].dataSeries._colorSet.length
                            ])
                  : (this.contentDiv.style.borderRightColor =
                      this.contentDiv.style.borderLeftColor =
                      this.contentDiv.style.borderColor =
    ...
    aa.prototype.fireEvent = function (a, d, c) {
      if (a && d) {
        ...
        "mouseout" !== d
          ? g.cursor &&
            g.cursor !== c.target.style.cursor &&
            (c.target.style.cursor = g.cursor)
    ...
    var P = {
      ...
      Y = {
        drawMarker: function (a, d, c, b, e, g, h, l) {
          if (c) {
            var r = 1;
            c.fillStyle = g ? g : "#000000";
            c.strokeStyle = h ? h : "#000000";
            c.lineWidth = l ? l : 0;
            c.setLineDash && c.setLineDash(K("solid", l));
            "circle" === b
              ? (c.moveTo(a, d),
                c.beginPath(),
